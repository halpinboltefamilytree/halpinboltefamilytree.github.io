var FamilyTree=function(e,t){var i=this;if(("string"==typeof e||e instanceof String)&&(e=document.querySelector(e)
),
this.element=e,this.config=FamilyTree.mergeDeep(FamilyTree._defaultConfig(t
),
t
),
this._layoutConfigs={base:{orientation:this.config.orientation,levelSeparation:this.config.levelSeparation,mixedHierarchyNodesSeparation:this.config.mixedHierarchyNodesSeparation,assistantSeparation:this.config.assistantSeparation,subtreeSeparation:this.config.subtreeSeparation,siblingSeparation:this.config.siblingSeparation,layout:this.config.layout,columns:this.config.columns,collapse:this.config.collapse,partnerNodeSeparation:this.config.partnerNodeSeparation}},this.config.tags)for(var r in this.config.tags){var a=this.config.tags[r];null!=a.subTreeConfig&&(this._layoutConfigs[r]={orientation:null!=a.subTreeConfig.orientation?a.subTreeConfig.orientation:this.config.orientation,levelSeparation:null!=a.subTreeConfig.levelSeparation?a.subTreeConfig.levelSeparation:this.config.levelSeparation,mixedHierarchyNodesSeparation:null!=a.subTreeConfig.mixedHierarchyNodesSeparation?a.subTreeConfig.mixedHierarchyNodesSeparation:this.config.mixedHierarchyNodesSeparation,assistantSeparation:null!=a.subTreeConfig.assistantSeparation?a.subTreeConfig.assistantSeparation:this.config.assistantSeparation,subtreeSeparation:null!=a.subTreeConfig.subtreeSeparation?a.subTreeConfig.subtreeSeparation:this.config.subtreeSeparation,siblingSeparation:null!=a.subTreeConfig.siblingSeparation?a.subTreeConfig.siblingSeparation:this.config.siblingSeparation,layout:null!=a.subTreeConfig.layout?a.subTreeConfig.layout:this.config.layout,columns:null!=a.subTreeConfig.columns?a.subTreeConfig.columns:this.config.columns,collapse:null!=a.subTreeConfig.collapse?a.subTreeConfig.collapse:this.config.collapse,partnerNodeSeparation:null!=a.subTreeConfig.partnerNodeSeparation?a.subTreeConfig.partnerNodeSeparation:this.config.partnerNodeSeparation})}this._event_id=FamilyTree._guid(
),
FamilyTree._validateConfig(this.config)&&(this._vScroll={},this.config.ui||(this.ui=FamilyTree.ui
),
this.config.editUI?this.editUI=this.config.editUI:this.editUI=new FamilyTree.editUI,this.editUI.init(this
),
this.config.filterUI?this.filterUI=this.config.filterUI:this.filterUI=new FamilyTree.filterUI,this.filterUI.init(this
),
this.manager=new FamilyTree.manager(this
),
this.config.searchUI?this.searchUI=this.config.searchUI:this.searchUI=new FamilyTree.searchUI,this.config.nodeMenuUI?this.nodeMenuUI=this.config.nodeMenuUI:this.nodeMenuUI=new FamilyTree.menuUI,this.nodeMenuUI.init(this,this.config.nodeMenu
),
this.config.nodeCircleMenuUI?this.nodeCircleMenuUI=this.config.nodeCircleMenuUI:this.nodeCircleMenuUI=new FamilyTree.circleMenuUI,this.nodeCircleMenuUI.init(this,this.config.nodeCircleMenu
),
this.config.nodeContextMenuUI?this.nodeContextMenuUI=this.config.nodeContextMenuUI:this.nodeContextMenuUI=new FamilyTree.menuUI,this.nodeContextMenuUI.init(this,this.config.nodeContextMenu
),
this.config.toolbarUI?this.toolbarUI=this.config.toolbarUI:this.toolbarUI=new FamilyTree.toolbarUI,this.config.notifierUI?this.notifierUI=this.config.notifierUI:this.notifierUI=new FamilyTree.notifierUI,this.notifierUI.init(this
),
this.config.menuUI?this.menuUI=this.config.menuUI:this.menuUI=new FamilyTree.menuUI,this.menuUI.init(this,this.config.menu
),
this.config.xScrollUI||(this.xScrollUI=new FamilyTree.xScrollUI(this.element,this.config,(function(){return{boundary:i.response.boundary,scale:i.getScale(
),
viewBox:i.getViewBox(
),
padding:i.config.padding}}
),
(function(e){i.setViewBox(e)}
),
(function(){i._draw(!0,FamilyTree.action.xScroll)}))
),
this.config.yScrollUI||(this.yScrollUI=new FamilyTree.yScrollUI(this.element,this.config,(function(){return{boundary:i.response.boundary,scale:i.getScale(
),
viewBox:i.getViewBox(
),
padding:i.config.padding}}
...
this._gragStartedId=null,this._timeout=null,this._touch=null,this._initialized=!1,this._loaded=!1,this._moveInterval=null,this._movePosition=null,this.response=null,this.nodes=null,this.isVisible=null,FamilyTree._intersectionObserver(this.element,(function(e){i.isVisible=e,!1!==FamilyTree.events.publish("visibility-change",[i])&&FamilyTree.LAZY_LOADING&&i.isVisible&&(i._loaded?i._draw(!1,FamilyTree.action.update):(i._setInitialSizeIfNotSet(
),
i._draw(!1,FamilyTree.action.init)))})))};FamilyTree._defaultConfig=function(e){return{interactive:!0,mode:"light",lazyLoading:!0,enableDragDrop:!1,enableSearch:!0,enableTouch:!1,enablePan:!0,keyNavigation:!1,miniMap:!1,nodeMenu:null,nodeCircleMenu:null,nodeContextMenu:null,menu:null,toolbar:!1,sticky:!0,nodeMouseClick:FamilyTree.action.details,nodeMouseDbClick:FamilyTree.none,mouseScrool:FamilyTree.action.zoom,showXScroll:FamilyTree.none,showYScroll:FamilyTree.none,template:"ana",tags:{},min:!1,nodeBinding:{},linkBinding:{},searchFields:null,searchDisplayField:null,searchFieldsWeight:null,searchFieldsAbbreviation:null,nodes:[],clinks:[],slinks:[],groupDottedLines:[],dottedLines:[],levelSeparation:60,siblingSeparation:20,subtreeSeparation:40,mixedHierarchyNodesSeparation:15,assistantSeparation:100,minPartnerSeparation:50,partnerChildrenSplitSeparation:20,partnerNodeSeparation:15,columns:10,padding:30,orientation:FamilyTree.orientation.top,layout:FamilyTree.normal,scaleInitial:1,scaleMin:.1,scaleMax:5,orderBy:null,editUI:null,filterUI:null,searchUI:null,xScrollUI:null,yScrollUI:null,nodeMenuUI:null,nodeCircleMenuUI:null,nodeContextMenuUI:null,toolbarUI:null,notifierUI:null,menuUI:null,exportUrl:"https://balkan.app/export",collapse:{},expand:{},align:FamilyTree.CENTER,UI:null,anim:{func:FamilyTree.anim.outPow,duration:200},zoom:{speed:120,smooth:12},roots:null,state:null,editForm:{readOnly:!1,titleBinding:"name",photoBinding:"img",addMore:"Add more fields",addMoreBtn:"Add",addMoreFieldName:"Field name",saveAndCloseBtn:"Save and close",cancelBtn:"Cancel",generateElementsFromFields:!0,focusBinding:null,buttons:{edit:{icon:FamilyTree.icon.edit(24,24,"#fff"
),
text:"Edit",hideIfEditMode:!0,hideIfDetailsMode:!1},share:{icon:FamilyTree.icon.share(24,24,"#fff"
),
text:"Share"},pdf:{icon:FamilyTree.icon.pdf(24,24,"#fff"
),
text:"Save as PDF"},remove:{icon:FamilyTree.icon.remove(24,24,"#fff"
),
text:"Remove",hideIfDetailsMode:!0}},elements:[]}}},FamilyTree.prototype.load=function(e){var t=this;return this.config.nodes=e,this._draw(!1,FamilyTree.action.init,void 0,(function(){t.filterUI.update()})
),
this},FamilyTree.prototype.loadXML=function(e){var t=FamilyTree._xml2json(e);return this.load(t)},FamilyTree.prototype.getXML=function(){return FamilyTree._json2xml(this.config.nodes)},FamilyTree.prototype.on=function(e,t){return FamilyTree.events.on(e,t,this._event_id
),
this},FamilyTree.prototype.draw=function(e,t,i){null==e&&(e=FamilyTree.action.update
),
this._draw(!1,e,t,i)},FamilyTree.prototype._draw=function(e,t,i,r){var a=this;if(!FamilyTree.LAZY_LOADING||this.isVisible)if(FamilyTree.LAZY_LOADING||this._initialized||(this._setInitialSizeIfNotSet(
),
0!=this.width()&&0!=this.height())){this._hideBeforeAnimationCompleted=!1;var n=t==FamilyTree.action.init?null:this.getViewBox();this.manager.read(e,this.width(
),
this.height(
),
n,t,i,(function(e){if(!a.notifierUI.show(e.notif)){t!=FamilyTree.action.exporting&&(a.nodes=e.nodes,a.visibleNodeIds=e.visibleNodeIds,a.roots=e.roots
),
a.editUI.fields=e.allFields;var n={defs:""};FamilyTree.events.publish("renderdefs",[a,n]);var l=a.ui.defs(n.defs
),
o=a.getScale(e.viewBox);l+=a.ui.pointer(a.config,t,o);var s=a.getViewBox(
),
d=e.viewBox;n={content:l,res:e};FamilyTree.events.publish("prerender",[a,n]
),
l=n.content;for(var c=0;c<e.visibleNodeIds.length;c++){var m=e.nodes[e.visibleNodeIds[c]],p=a._get(m.id);FamilyTree.RENDER_LINKS_BEFORE_NODES&&(l+=a.ui.link(m,a,o,e.bordersByRootIdAndLevel,e.nodes,t)
),
l+=a.ui.node(m,p,e.animations,a.config,void 0,void 0,void 0,t,o,a)}for(c=0;c<e.visibleNodeIds.length;c++){m=e.nodes[e.visibleNodeIds[c]];FamilyTree.RENDER_LINKS_BEFORE_NODES||(l+=a.ui.link(m,a,o,e.bordersByRootIdAndLevel,e.nodes,t)
),
l+=a.ui.expandCollapseBtn(a,m,a._layoutConfigs,t,o)}n={content:l,res:e};if(FamilyTree.events.publish("render",[a,n]
),
l=n.content,e=n.res,l+=a.ui.lonely(a.config
),
t!==FamilyTree.action.exporting){t!==FamilyTree.action.centerNode&&t!==FamilyTree.action.insert&&t!==FamilyTree.action.expand&&t!==FamilyTree.action.collapse&&t!==FamilyTree.action.update||(d=s
),
t===FamilyTree.action.init&&null!=s&&(d=s
),
a.response=e;v=a.ui.svg(a.width(
),
a.height(
),
d,a.config,l);if(a._initialized){var h=a.getSvg(
),
f=h.parentNode;f.removeChild(h
),
...
a.yScrollUI.setPosition()}else a.element.innerHTML=a.ui.css()+v+a.ui.menuButton(a.config
),
a._attachInitEventHandlers(
),
a._attachEventHandlers(
),
a.xScrollUI.create(a.width(
),
a.config.padding
),
a.xScrollUI.setPosition(
...
a.toolbarUI.init(a,a.config.toolbar);var u=!1,y=a.response.animations;if(y[0].length>0){a._hideBeforeAnimation(y[0].length);for(c=0;c<y[0].length;c++)y[0][c]=a.getNodeElement(y[0][c]);FamilyTree.animate(y[0],y[1],y[2],a.config.anim.duration,a.config.anim.func,(function(){u||(r&&r(
),
FamilyTree.events.publish("redraw",[a]
),
a._showAfterAnimation(
),
u=!0)}))}t===FamilyTree.action.centerNode?FamilyTree.animate(a.getSvg(
),
{viewbox:s},{viewbox:a.response.viewBox},a.config.anim.duration,a.config.anim.func,(function(){a.ripple(i.options.rippleId
),
u||(r&&r(
),
FamilyTree.events.publish("redraw",[a]
...
(function(){a.xScrollUI.setPosition(
),
a.yScrollUI.setPosition()})):!s||!a.response||s[0]==a.response.viewBox[0]&&s[1]==a.response.viewBox[1]&&s[2]==a.response.viewBox[2]&&s[3]==a.response.viewBox[3]||t!==FamilyTree.action.insert&&t!==FamilyTree.action.expand&&t!==FamilyTree.action.collapse&&t!==FamilyTree.action.update&&t!==FamilyTree.action.init?0==y[0].length&&(u||(r&&r(
),
FamilyTree.events.publish("redraw",[a]
),
u=!0)):FamilyTree.animate(a.getSvg(
),
{viewbox:s},{viewbox:a.response.viewBox},2*a.config.anim.duration,a.config.anim.func,(function(){a.xScrollUI.setPosition(
),
a.yScrollUI.setPosition(
),
u||(r&&r(
...
!a._loaded&&e&&e.nodes&&Object.keys(e.nodes).length&&(a._loaded=!0)}else{var g=e.boundary,T=g.maxX-g.minX,b=g.maxY-g.minY,v=a.ui.svg(T,b,[g.minX,g.minY,T,b],a.config,l,o);r(v)}}}
),
(function(e){FamilyTree.events.publish("ready",[a,e])}))}else console.error("Cannot load the family with size 0! If you are using the FamilyTree within tabs set FamilyTree.LAZY_LOADING to true! ")},FamilyTree.prototype._setInitialSizeIfNotSet=function(){this.element.style.overflow="hidden",this.element.style.position="relative",0==this.element.offsetHeight&&(this.element.style.height="100%",0==this.element.offsetHeight&&(this.element.style.height="700px")
),
0==this.element.offsetWidth&&(this.element.style.width="100%",0==this.element.offsetWidth&&(this.element.style.width="700px"))},FamilyTree.prototype.width=function(){return this.element.offsetWidth},FamilyTree.prototype.height=function(){return this.element.offsetHeight},FamilyTree.prototype.getViewBox=function(){var e=this.getSvg();return FamilyTree._getViewBox(e)},FamilyTree.prototype.setViewBox=function(e){this.getSvg().setAttribute("viewBox",e.toString())},FamilyTree.prototype.getScale=function(e){return e||(e=this.getViewBox()
),
FamilyTree.getScale(e,this.width(
),
this.height(
),
this.config.scaleInitial,this.config.scaleMax,this.config.scaleMin)},FamilyTree.prototype.ripple=function(e,t,i){var r=this.getNode(e);if(null!=r){var a=this.getNodeElement(e);if(null!=a){var n=this.getScale(
),
l=r.w/2,o=r.h/2;if(void 0!==t&&void 0!==i){var s=a.getBoundingClientRect();l=t/n-s.left/n,o=i/n-s.top/n}var d=r.w,c=r.h,m=d-l>l?d-l:l,p=c-o>o?c-o:o,h=m>p?m:p,f=document.createElementNS("http://www.w3.org/2000/svg","g"
),
...
T=FamilyTree.randomId();u.setAttribute("id",T);var b={ripple:FamilyTree.t(r.templateName,r.min,this.getScale()).ripple,node:r};FamilyTree.events.publish("ripple",[this,b]
),
...
FamilyTree.animate(g,{r:0,opacity:1},{r:h,opacity:0},500,FamilyTree.anim.outPow,(function(){a.removeChild(f)}))}}},FamilyTree.prototype.center=function(e,t,i){var r,a,n=e,l=!0,o=!0;t&&null!=t.parentState&&(r=t.parentState
),
...
e&&(e.innerHTML=FamilyTree.toolbarUI.closeFullScreenIcon))},FamilyTree.prototype.getNode=function(e){return this.nodes[e]},FamilyTree.prototype.setLayout=function(e,t){t||(t="base"
),
this._layoutConfigs[t].layout=e,this._draw(!1,FamilyTree.action.update)},FamilyTree.prototype.setOrientation=function(e,t){t||(t="base"
),
this._layoutConfigs[t].orientation=e,this._draw(!1,FamilyTree.action.update)},FamilyTree.prototype.search=function(e,t,i){return FamilyTree.isNEU(t)&&(t=this.searchUI._searchFields
),
FamilyTree.isNEU(i)&&(i=t
),
FamilyTree._search.search(this.config.nodes,e,t,i,this.config.searchDisplayField,this.config.searchFieldsWeight,this.searchUI._searchFieldsAbbreviation)},FamilyTree.prototype._hideBeforeAnimation=function(e){if(1!=this._hideBeforeAnimationCompleted&&!(e&&e<FamilyTree.ANIM_THRESHOLD)){var t=this.element.getElementsByTagName("text");if(t.length>FamilyTree.TEXT_THRESHOLD)for(var i=0;i<t.length;i++)t[i].style.display="none";var r=this.element.getElementsByTagName("image");if(r.length>FamilyTree.IMAGES_THRESHOLD)for(i=0;i<r.length;i++)r[i].style.display="none";var a=this.element.querySelectorAll("["+FamilyTree.attr.link_id+"]");if(a.length>FamilyTree.LINKS_THRESHOLD)for(i=0;i<a.length;i++)a[i].style.display="none";var n=this.element.querySelectorAll("["+FamilyTree.attr.control_expcoll_id+"]");if(n.length>FamilyTree.BUTTONS_THRESHOLD)for(i=0;i<n.length;i++)n[i].style.display="none";var l=this.element.querySelectorAll("["+FamilyTree.attr.control_up_id+"]");if(l.length>FamilyTree.BUTTONS_THRESHOLD)for(i=0;i<l.length;i++)l[i].style.display="none";this._hideBeforeAnimationCompleted=!0}},FamilyTree.prototype._showAfterAnimation=function(){for(var e=this.element.getElementsByTagName("text"
),
t=0;t<e.length;t++)e[t].style.display="";var i=this.element.getElementsByTagName("image");for(t=0;t<i.length;t++)i[t].style.display="";var r=this.element.querySelectorAll("["+FamilyTree.attr.link_id+"]");for(t=0;t<r.length;t++)r[t].style.display="";var a=this.element.querySelectorAll("["+FamilyTree.attr.control_expcoll_id+"]");for(t=0;t<a.length;t++)a[t].style.display="";var n=this.element.querySelectorAll("["+FamilyTree.attr.control_up_id+"]");for(t=0;t<n.length;t++)n[t].style.display="";this._hideBeforeAnimationCompleted=!1},FamilyTree.prototype.isChild=function(e,t){for(var i=this.getNode(t);i;){if(i.id==e)return!0;i=i.parent?i.parent:i.stParent}return!1},FamilyTree.prototype.getCollapsedIds=function(e){for(var t=[],i=0;i<e.childrenIds.length;i++){var r=this.getNode(e.childrenIds[i]);1==r.collapsed&&t.push(r.id)}return t},FamilyTree.prototype.stateToUrl=function(){if(this.manager.state){var e={};return e.exp=this.manager.state.exp.join("*"
),
e.min=this.manager.state.min.join("*"
),
e.adjustify=this.manager.state.adjustify.x+"*"+this.manager.state.adjustify.y,e.scale=this.manager.state.scale,e.y=this.manager.state.x,e.x=this.manager.state.y,new URLSearchParams(e).toString()}return""},FamilyTree.prototype.generateId=function(){for(;;){var e="_"+("0000"+(Math.random()*Math.pow(36,4)|0).toString(36)).slice(-4);if(!this.nodes.hasOwnProperty(e))return e}},FamilyTree.prototype._nodeHasHiddenParent=function(e){return!e.parent&&!FamilyTree.isNEU(e.pid)&&this.getNode(e.pid)},FamilyTree.prototype.destroy=function(){this._removeEvent(window,"resize"
),
...
t},FamilyTree.prototype.getRecentRootsByNodeId=function(e){this.recentRoots||(this.recentRoots=[]);var t=this.recentRoots,i=this.getNode(e);return i?(i.rids.sort((function(e,i){var r=t.indexOf(e
),
a=t.indexOf(i);return-1==r?1e3:-1==a?-1e3:r-a})
),
i.rids):[]},FamilyTree.prototype._nodeHasHiddenParent=function(e){return!(e.parent||FamilyTree.isNEU(e.pid)||!this.getNode(e.pid))||(!(!e.isPartner||FamilyTree.isNEU(e.mid)||!this.getNode(e.mid))||(!(!e.isPartner||FamilyTree.isNEU(e.fid)||!this.getNode(e.fid))||!!(e.isPartner&&e.pids.length>1)))},FamilyTree.prototype._center=FamilyTree.prototype.center,FamilyTree.prototype.center=function(e,t,i){var r=this.getRecentRootsByNodeId(e);Array.isArray(this.config.roots)||(roots=[]
),
FamilyTree._changeRootOption(this.config.roots,r,this.manager.rootList
),
this._center(e,t,i)},FamilyTree.localStorage={},FamilyTree.localStorage.getItem=function(e){var t=localStorage.getItem("to_date");if(t){if((t=new Date(t))<new Date){for(var i=0,r=localStorage.length;i<r;++i){var a=localStorage.key(i);a&&a.startsWith&&a.startsWith('{"n"')&&localStorage.removeItem(a)}localStorage.removeItem("to_date")}}else(t=new Date).setDate(t.getDate()+5
),
t=t.toISOString(
),
localStorage.setItem("to_date",t);return localStorage.getItem(e)},FamilyTree.localStorage.setItem=function(e,t){try{localStorage.setItem(e,t)}catch(e){e.code==e.QUOTA_EXCEEDED_ERR?(console.warn("Local storage quota exceeded"
),
localStorage.clear()):(console.error("Local storage error code:"+e.code
),
console.error(e))}},FamilyTree.prototype.canUpdateLink=function(e,t){if(null==t||null==t)return!1;if(null==e||null==e)return!1;if(e==t)return!1;var i=this.getNode(t
),
r=this.getNode(e);return!(i&&r&&(i.isPartner||i.hasPartners&&r.isAssistant||i.hasAssistants&&r.isPartner))&&!this.isChild(e,t)},FamilyTree.prototype._canUpdateLink=FamilyTree.prototype.canUpdateLink,FamilyTree.prototype.updateNode=function(e,t,i){var r=this,a=this.get(e.id);if(!0===i&&!1===FamilyTree.events.publish("update",[this,a,e]))return!1;this.update(e);var n=this.getNode(e.id
),
l=n.pid;null==l&&(l=n.stpid
),
this._draw(!1,FamilyTree.action.update,{id:l},(function(){r.ripple(e.id
),
t&&t(
),
FamilyTree.events.publish("updated",[r,a,e]
),
r.filterUI.update()}))},FamilyTree.prototype.update=function(e){for(var t=0;t<this.config.nodes.length;t++)if(this.config.nodes[t].id==e.id){this.config.nodes[t]=e;break}return this},FamilyTree.prototype.removeNode=function(e,t,i){var r=this;if(!this.canRemove(e))return!1;var a=this._getNewPidsAndStpidsForIds(e);if(!0===i&&!1===FamilyTree.events.publish("remove",[this,e,a]))return!1;return this.remove(e
),
this._draw(!1,FamilyTree.action.update,null,(function(){r.config.sticky&&FamilyTree._moveToBoundaryArea(r.getSvg(
),
r.getViewBox(
),
r.response.boundary
...
!0},FamilyTree.prototype.remove=function(e){var t=this.get(e);if(t)for(var i=this.config.nodes.length-1;i>=0;i--)this.config.nodes[i].pid!=e&&this.config.nodes[i].stpid!=e||(this.config.nodes[i].pid=t.pid,this.config.nodes[i].stpid=t.stpid
),
this.config.nodes[i].id==e&&this.config.nodes.splice(i,1);return this},FamilyTree.prototype._getNewPidsAndStpidsForIds=function(e){var t=this.get(e
),
i={},r={};if(t)for(var a=this.config.nodes.length-1;a>=0;a--)this.config.nodes[a].pid==e?i[this.config.nodes[a].id]=t.pid:this.config.nodes[a].stpid==e&&(r[this.config.nodes[a].id]=t.stpid);return{newPidsForIds:i,newStpidsForIds:r}},FamilyTree.prototype.addNode=function(e,t,i){var r=this;if(!0===i&&!1===FamilyTree.events.publish("add",[this,e]))return!1;this.add(e
),
r._draw(!1,FamilyTree.action.insert,{id:e.pid,insertedNodeId:e.id},(function(){r.ripple(e.id
),
t&&t(
),
...
FamilyTree.events.publish("updating",[r,a])}}},FamilyTree.prototype.addChildAndPartnerNodes=function(e,t,i,r,a){this.hideTreeMenu(!1);var n=this;if(!t||FamilyTree.isNEU(t.mid)&&FamilyTree.isNEU(t.fid))console.error("addChildAndPartnerNodes invalid childData");else if(i){FamilyTree.isNEU(t.id)&&(t.id=this.generateId()
),
FamilyTree.isNEU(i.id)&&(i.id=this.generateId()
),
"_ft_partner"==t.mid?t.mid=i.id:"_ft_partner"==t.fid&&(t.fid=i.id);var l=[],o=null;Array.isArray(i.pids)&&(1!=i.pids.length&&console.error("addChildAndPartnerNodes partnerData.pids has to have one partner"
),
o=this.get(i.pids[0]
),
...
l.push(d));var c={addNodesData:[i],updateNodesData:l,removeNodeId:null};if(!1!==this._fireUpdate_addUpdateRemove(c,a)){var m=this.getRecentRootsByNodeId(e);FamilyTree._changeRootOption(this.config.roots,m,this.manager.rootList);var p="";d&&(p=d.id
),
n._draw(!1,FamilyTree.action.update,{id:p},(function(){n.ripple(i.id
),
r&&r(
),
...
FamilyTree.events.publish("updating",[r,n])}}else console.error("addPartnerNode invalid data")},FamilyTree.prototype.addParentNode=function(e,t,i,r,a){this.hideTreeMenu(!1);var n=this;if(i){if(["mid","fid"].has(t))if(FamilyTree.isNEU(e))console.error("addParentNode invalid childId");else{FamilyTree.isNEU(i.id)&&(i.id=this.generateId());var l=[],o=this.get(e);o[t]=i.id,l.push(o);var s=null;Array.isArray(i.pids)&&(1!=i.pids.length&&console.error("addParentNode: data has to have one partner"
),
s=this.get(i.pids[0]
),
...
l.push(s));var d={removeNodeId:null,updateNodesData:l,addNodesData:[i]};if(!1!==this._fireUpdate_addUpdateRemove(d,a)){var c=e;this.config.roots=[d.addNodesData[0].id],this._draw(!1,FamilyTree.action.insert,{id:c,insertedNodeId:d.addNodesData[0].id},(function(){n.ripple(d.addNodesData[0].id
),
r&&r(
),
...
FamilyTree.events.publish("updating",[n,d])}}else console.error("addParentNode invalid type")}else console.error("addParentNode invalid data")},FamilyTree.prototype.canRemove=function(e){var t=this.getNode(e);if(!t)return!1;var i=this.getNode(t.mid
),
r=this.getNode(t.fid
),
a=t.ftChildrenIds.length>0,n=!1,l=t.pids.length>0,o=t.pids.length>1;if(1==t.pids.length){var s=this.getNode(t.pids[0]);n=t.ftChildrenIds.compare(s.ftChildrenIds)}return!(!i&&!r||a||l)||(!(i||r||a||o||!l||n)||(!(i||r||!a||!n)||!(i||r||a||!n)))},FamilyTree.prototype.removeNode=function(e,t,i){var r=this;if(this.canRemove(e)){var a=this.getNode(e
),
n=[];if(Array.isArray(a.pids))for(var l=0;l<a.pids.length;l++){var o=this.get(a.pids[l]);if(o)-1!=(d=o.pids.indexOf(a.id))&&(o.pids.splice(d,1
),
n.push(o))}if(Array.isArray(a.ftChildrenIds))for(l=0;l<a.ftChildrenIds.length;l++){var s=this.get(a.ftChildrenIds[l]);s&&(s.mid==a.id?(s.mid=void 0,n.push(s)):s.fid==a.id&&(s.fid=void 0,n.push(s)))}var d,c={removeNodeId:e,updateNodesData:n,addNodesData:[]};if(!1!==this._fireUpdate_addUpdateRemove(c,i))-1!=(d=this.config.roots.indexOf(e))&&this.config.roots.splice(d,1
),
this._draw(!1,FamilyTree.action.update,null,(function(){r.config.sticky&&FamilyTree._moveToBoundaryArea(r.getSvg(
),
r.getViewBox(
...
FamilyTree.events.publish("updating",[r,c])}},FamilyTree.prototype.updateNode=function(e,t,i){var r=this,a=this.getNode(e.id);e.pids||(e.pids=[]);var n=[];n.push(e);for(var l=0;l<a.pids.length;l++){if(!e.pids.has(a.pids[l]))if((s=this._get(a.pids[l]))&&s.pids){var o=s.pids.indexOf(e.id);-1!=o&&(s.pids.splice(o,1
),
n.push(e)
),
a.pids.splice(l,1
),
n.push(s)}}for(l=0;l<e.pids.length;l++){var s;if(!a.pids||!a.pids.has(e.pids[l]))(s=this._get(e.pids[l])).pids||(s.pids=[]
),
s.pids.push(e.pids[l]
),
n.push(s)}var d={removeNodeId:null,updateNodesData:n,addNodesData:[]};!1!==this._fireUpdate_addUpdateRemove(d,i)&&(this._draw(!1,FamilyTree.action.update,null,(function(){r.config.sticky&&FamilyTree._moveToBoundaryArea(r.getSvg(
),
r.getViewBox(
),
r.response.boundary
...
Array.isArray(f.tags)&&f.tags.length)for(b=0;b<f.tags.length;b++)I.classList.add(f.tags[b]);I.style.display="flex",I.style.opacity=i?1:0,I.style.right=i?0:"-20px",r&&(I.style.width=r);var A=[],N=a?"":FamilyTree.EDITFORM_CLOSE_BTN;return I.innerHTML=`<div>\n                        <div class="bft-edit-form-header" ${C}>\n                            ${N}\n                            ${FamilyTree.editUI.renderHeaderContent(g,T,f,u)}\n                        </div>\n                        <div data-bft-edit-from-btns class="bft-edit-form-instruments">\n                        ${function(){if(a)return"";var e="";for(var i in m){var r=m[i];FamilyTree.isNEU(r)||(w&&r.hideIfEditMode||t&&r.hideIfDetailsMode||l&&"Edit"==r.text||(e+=`<div data-edit-from-btn='${i}' class="bft-img-button" ${C} title="${r.text}">${r.icon}</div>`))}return e}()}    \n                        </div>\n                    </div>\n                    <div class="bft-edit-form-fields">\n                        <div class="bft-edit-form-fields-inner">\n                            <div class="bft-form-fieldset">\n                                ${function(){for(var e="",i=0;i<o.length;i++){var r=o[i];if(Array.isArray(r)){e+='<div class="bft-form-field-100 bft-form-fieldset">';for(var a=0;a<r.length;a++){var l=r[a],s=FamilyTree.elements[l.type](u,l,"unset",t);!FamilyTree.isNEU(s.id)&&FamilyTree.isNEU(n)&&FamilyTree.isNEU(s.value)&&(n=s.id
),
FamilyTree.isNEU(s.value)||A.push(`${l.label}: ${s.value}`
),
e+=s.html}e+="</div>"}else{s=FamilyTree.elements[r.type](u,r,"280px",t);!FamilyTree.isNEU(s.id)&&FamilyTree.isNEU(n)&&FamilyTree.isNEU(s.value)&&(n=s.id
),
FamilyTree.isNEU(s.value)||A.push(`${r.label}: ${s.value}`
),
e+=s.html}}return e}()}\n\n                                <div class="bft-form-field" style="min-width: 280px; text-align:center; ${S}">\n                                    <a data-add-more-fields-btn href="#" class="bft-link">${s}</a>\n                                </div>\n                            </div>        \n                        </div>\n                    </div>\n                    <div class="bft-form-fieldset" style="padding: 14px 10px; ${k}">\n                        <div class="bft-form-field" style="min-width: initial;">\n                            <button data-edit-from-cancel type="button" class="bft-button transparent">${c}</button>\n                        </div>\n                        <div class="bft-form-field" style="min-width: initial;">\n                            <button type="submit" data-edit-from-save type="button" class="bft-button">${d}</button>\n                        </div>\n                    </div>`,{element:I,focusId:n,title:g,shareText:A.join("\n")}},FamilyTree.editUI.prototype.hide=function(){if(!1===FamilyTree.events.publish("hide",[this]))return!1;FamilyTree.isNEU(this.interval)&&(clearInterval(this.interval
),
this.interval=null);var e=this.obj.element.querySelector("[data-bft-edit-form]");e&&e.parentNode&&e.parentNode.removeChild(e)},FamilyTree.editUI.renderHeaderContent=function(e,t,i,r){return`<h1 class="bft-edit-form-title">${FamilyTree._escapeGreaterLessSign(e)}</h1>\n                <div id="bft-avatar" class="bft-edit-form-avatar">${t}</div>`},FamilyTree.prototype.getSvg=function(){var e=this.element.getElementsByTagName("svg");return e&&e.length?e[0]:null},FamilyTree.prototype.getPointerElement=function(){return this.element.querySelector("g[data-pointer]")},FamilyTree.prototype.getNodeElement=function(e){return this.element.querySelector("g["+FamilyTree.attr.node_id+"='"+e+"']")},FamilyTree.prototype.getMenuButton=function(){return this.element.querySelector("["+FamilyTree.attr.control_export_menu+"]")},FamilyTree.menuUI=function(){},FamilyTree.menuUI.prototype.init=function(e,t){this.obj=e,this.wrapper=null,this.menu=t,this._event_id=FamilyTree._guid()},FamilyTree.menuUI.prototype.showStickIn=function(e,t,i,r){this._show(e,null,t,i,r)},FamilyTree.menuUI.prototype.show=function(e,t,i,r,a){this._show(e,t,i,r,a)},FamilyTree.menuUI.prototype._show=function(e,t,i,r,a){var n=this;this.hide();var l="";a||(a=this.menu);var o={firstNodeId:i,secondNodeId:r,menu:a};if(!1===FamilyTree.events.publish("show",[this,o]))return!1;for(var s in a=o.menu){var d=a[s].icon,c=a[s].text;void 0===d&&(d=FamilyTree.icon[s]?FamilyTree.icon[s](24,24,"#7A7A7A"):""
),
"function"==typeof c&&(c=c()
),
"function"==typeof d&&(d=d()
),
l+="<div "+FamilyTree.attr.item+'="'+s+'">'+d+"<span>&nbsp;&nbsp;"+c+"</span></div>"}if(""!=l){if(this.wrapper=document.createElement("div"
),
this.wrapper.className="bft-family-menu",this.wrapper.style.left="-99999px",this.wrapper.style.top="-99999px",this.wrapper.innerHTML=l,this.obj.element.appendChild(this.wrapper
),
null==t){var m=FamilyTree._menuPosition(e,this.wrapper,this.obj.getSvg());e=m.x,t=m.y}var p=e+45;this.wrapper.style.left=p+"px",this.wrapper.style.top=t+"px",this.wrapper.style.left=p-this.wrapper.offsetWidth+"px";var h=e-this.wrapper.offsetWidth;FamilyTree.animate(this.wrapper,{opacity:0,left:p-this.wrapper.offsetWidth},{opacity:1,left:h},300,FamilyTree.anim.inOutPow);for(var f=this.wrapper.getElementsByTagName("div"
),
u=0;u<f.length;u++){(s=f[u]).addEventListener("click",(function(e){var t,l=this.getAttribute(FamilyTree.attr.item);if(void 0===a[l].onClick)if("add"===l){var o={id:n.obj.generateId(
),
pid:i};n.obj.addNode(o,null,!0)}else if("edit"===l){var s=n.obj.getNode(i);n.obj.editUI.show(s.id)}else if("details"===l){s=n.obj.getNode(i);n.obj.editUI.show(s.id,!0)}else"remove"===l?n.obj.removeNode(i,null,!0):"svg"===l?n.obj.exportSVG({filename:"FamilyTree.svg",expandChildren:!1,nodeId:i}):"pdf"===l?n.obj.exportPDF({filename:"FamilyTree.pdf",expandChildren:!1,nodeId:i}):"png"===l?n.obj.exportPNG({filename:"FamilyTree.png",expandChildren:!1,nodeId:i}):"csv"===l?n.obj.exportCSV():"xml"===l?n.obj.exportXML():"json"===l&&n.obj.exportJSON();else t=a[l].onClick.call(n.obj,i,r);0!=t&&n.hide()}))}}},FamilyTree.menuUI.prototype.hide=function(){null!=this.wrapper&&(this.obj.element.removeChild(this.wrapper
),
this.wrapper=null)},FamilyTree.menuUI.prototype.on=function(e,t){return FamilyTree.events.on(e,t,this._event_id
),
this},FamilyTree.circleMenuUI=function(){},FamilyTree.circleMenuUI.prototype.init=function(e,t){this.obj=e,this.menu=t,this._menu=null,this._buttonsInterval=[],this._linesInterval=[],this._event_id=FamilyTree._guid()},FamilyTree.circleMenuUI.prototype.show=function(e,t){this._show(e,t)},FamilyTree.circleMenuUI.prototype._show=function(e,t){var i=this,r=this.obj.getNode(e
),
a=FamilyTree.t(r.templateName,r.min,this.obj.getScale());if(!FamilyTree.isNEU(a.nodeCircleMenuButton)){var n=this.obj.getSvg(
),
...
c=s[4]+d[4],m=s[5]+d[5],p=l.querySelectorAll("line"
),
h=this.obj.element.querySelector("["+FamilyTree.attr.control_node_circle_menu_wrraper_id+"]");if(FamilyTree.isNEU(h)||h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id)!=e){this.hide(
),
t||(t=this.menu);var f={nodeId:e,menu:t},u=FamilyTree.events.publish("show",[this,f]);if(this._menu=t,!1===u)return!1;for(var y=0,g=Object.keys(f.menu).length,T=2*a.nodeCircleMenuButton.radius+4,b=2*Math.PI*T,v=b/g-(2*a.nodeCircleMenuButton.radius+2);v<0;)T+=8,v=(b=2*Math.PI*T)/g-(2*a.nodeCircleMenuButton.radius+2);for(var F in(h=document.createElementNS("http://www.w3.org/2000/svg","g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id,e
),
h.setAttribute("transform","matrix(1,0,0,1,"+c+","+m+")"
),
n.appendChild(h
),
f.menu){var x=f.menu[F].icon,_=f.menu[F].color,w=f.menu[F].text;"function"==typeof x&&(x=x()
),
"function"==typeof _&&(_=_()
),
"function"==typeof w&&(w=w());var k=document.createElementNS("http://www.w3.org/2000/svg","g");k.setAttribute("transform","matrix(1,0,0,1,0,0)"
),
k.setAttribute(FamilyTree.attr.control_node_circle_menu_name,F
),
k.style.cursor="pointer";var S=document.createElementNS("http://www.w3.org/2000/svg","title");FamilyTree.isNEU(w)||(S.innerHTML=w);var C=document.createElementNS("http://www.w3.org/2000/svg","circle");C.setAttribute("cx",0
),
C.setAttribute("cy",0
),
...
k.innerHTML+=x,h.appendChild(k);var I=k.getElementsByTagName("svg")[0];if(I.setAttribute("pointer-events","none"
),
I){var A=parseInt(I.getAttribute("width")
),
N=parseInt(I.getAttribute("height"));I.setAttribute("x",-A/2
),
I.setAttribute("y",-N/2)}var M=y*Math.PI/(g/2);y++;var E=Math.cos(M)*T,L=Math.sin(M)*T;this._buttonsInterval.push(FamilyTree.animate(k,{transform:[1,0,0,1,0,0]},{transform:[1,0,0,1,E,L]},250,FamilyTree.anim.outBack,(function(e){var t=e[0].getAttribute(FamilyTree.attr.control_node_circle_menu_name
),
r=e[0].parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id);e[0].addEventListener("mouseenter",(function(e){FamilyTree.events.publish("mouseenter",[i,{from:r,menuItem:f.menu[t],menuItemName:t,event:e}])})
),
e[0].addEventListener("mouseout",(function(e){FamilyTree.events.publish("mouseout",[i,{from:r,menuItem:f.menu[t],menuItemName:t,event:e}])}))})))}this._linesInterval.push(FamilyTree.animate(p[0],{x1:-a.nodeCircleMenuButton.radius/2,y1:-6,x2:a.nodeCircleMenuButton.radius/2,y2:-6},{x1:-7,y1:-7,x2:7,y2:7},500,FamilyTree.anim.inOutSin)
),
...
this._linesInterval.push(FamilyTree.animate(p[2],{x1:-a.nodeCircleMenuButton.radius/2,y1:6,x2:a.nodeCircleMenuButton.radius/2,y2:6},{x1:-7,y1:7,x2:7,y2:-7},500,FamilyTree.anim.inOutSin))}else this.hide()}},FamilyTree.circleMenuUI.prototype.hide=function(){for(var e=this._buttonsInterval.length-1;e>=0;e--)clearInterval(this._buttonsInterval[e]
),
this._buttonsInterval.splice(e,1);this._buttonsInterval=[];for(e=this._linesInterval.length-1;e>=0;e--)clearInterval(this._linesInterval[e]
),
this._linesInterval.splice(e,1);this._linesInterval=[];var t=this.obj.element.querySelector("["+FamilyTree.attr.control_node_circle_menu_wrraper_id+"]");if(null!=t){var i=t.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id
),
r=this.obj.getNode(i
),
a=FamilyTree.t(r.templateName,r.min,this.obj.getScale()
),
n=this.obj.element.querySelector("["+FamilyTree.attr.control_node_circle_menu_id+'="'+i+'"]').querySelectorAll("line");n[0].setAttribute("x1",-a.nodeCircleMenuButton.radius/2
),
...
t&&t(!1)},r.onsuccess=function(e){t&&t(!0)}}else t&&t(i)}))},FamilyTree.idb.put=function(e,t){FamilyTree.idb._open((function(i){if(i){var r=FamilyTree.idb.db.transaction([FamilyTree.idb.tableName],"readwrite").objectStore(FamilyTree.idb.tableName).put(e);r.onerror=function(e){console.error("Unable to put data to database!"
),
...
this.layoutBtn=this.div.querySelector("["+FamilyTree.attr.tlbr+'="layout"]');var i=this.div.querySelector("["+FamilyTree.attr.tlbr+'="plus"]'
),
...
o=this;i&&i.addEventListener("click",(function(){o.obj.zoom(!0,null,!0)})
),
r&&r.addEventListener("click",(function(){o.obj.zoom(!1,null,!0)})
),
a&&a.addEventListener("click",(function(){o.obj.fit()})
),
n&&n.addEventListener("click",(function(){o.obj.toggleFullScreen()})
),
l&&l.addEventListener("click",(function(){o.obj.expand(null,"all")})
),
this.layoutBtn&&this.layoutBtn.addEventListener("click",(function(){o._visible?o.hideLayout():o.showLayout()})
),
this.layouts&&this.layouts.addEventListener("click",(function(e){for(var t=e.target;t;){if(t.hasAttribute&&t.hasAttribute(FamilyTree.attr.layout)){t=t.getAttribute(FamilyTree.attr.layout
),
o.obj.setLayout(FamilyTree[t]);break}t=t.parentNode}}))}},FamilyTree.toolbarUI.prototype.showLayout=function(){this._visible=!0,this.layoutBtn.style.transform="rotate(180deg) translateX(0px) translateY(0px)",FamilyTree.animate(this.div,{bottom:this.obj.config.padding-10},{bottom:this.obj.config.padding+135},this.obj.config.anim.duration,this.obj.config.anim.func
),
FamilyTree.animate(this.layouts,{bottom:-145},{bottom:0},this.obj.config.anim.duration,this.obj.config.anim.func)},FamilyTree.toolbarUI.prototype.hideLayout=function(){this._visible=!1,this.layoutBtn.style.transform="rotate(0deg) translateX(0px) translateY(0px)",FamilyTree.animate(this.div,{bottom:this.obj.config.padding+135},{bottom:this.obj.config.padding-10},this.obj.config.anim.duration,this.obj.config.anim.func
),
FamilyTree.animate(this.layouts,{bottom:0},{bottom:-145},this.obj.config.anim.duration,this.obj.config.anim.func)},FamilyTree.notifierUI=function(){},FamilyTree.notifierUI.prototype.init=function(e){this.obj=e},FamilyTree.notifierUI.prototype.show=function(e,t){if(null==e)return!1;1==e&&(e=FamilyTree.MAX_NODES_MESS,t="#FFCA28"
),
2==e&&(e=FamilyTree.OFFLINE_MESS,t="#FFCA28");var i=document.createElement("div");i.innerHTML=e,Object.assign(i.style,{position:"absolute","background-color":t,color:"#ffffff",padding:"15px","border-radius":"40px",opacity:0,overflow:"hidden","white-space":"nowrap","text-align":"center"}
),
this.obj.element.appendChild(i);var r=this.obj.width()/2-i.offsetWidth/2,a=this.obj.height()/2-i.offsetHeight/2;i.style.left=r+"px",i.style.top=a+"px";var n=i.offsetWidth;return i.style.width="20px",FamilyTree.animate(i,{opacity:0,width:10},{opacity:1,width:n},this.obj.config.anim.duration,this.obj.config.anim.func
),
!0},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree._validateConfig=function(e){return!!e||(console.error("config is not defined"
),
!1)},FamilyTree._arrayContains=function(e,t){if(e&&Array.isArray(e))for(var i=e.length;i--;)if(e[i]===t)return!0;return!1},FamilyTree._interceptions=function(e,t){if(!e)return[];if(!t)return[];var i=[];if(Array.isArray(e)&&Array.isArray(t))for(var r in e)for(var a in t)e[r]==t[a]&&i.push(e[r]);else if(Array.isArray(e)&&!Array.isArray(t))for(var r in e)for(var a in t)e[r]==a&&i.push(e[r]);else if(!Array.isArray(e)&&Array.isArray(t))for(var r in e)for(var a in t)r==t[a]&&i.push(t[a]);return i},FamilyTree._getTags=function(e){return e.tags&&!Array.isArray(e.tags)?e.tags.split(","):e.tags&&Array.isArray(e.tags)?e.tags:[]},FamilyTree._centerPointInPercent=function(e,t,i){var r=e.getBoundingClientRect(
),
a=t-r.left,n=i-r.top;return[a/(r.width/100
),
n/(r.height/100)]},FamilyTree._trim=function(e){return e.replace(/^\s+|\s+$/g,"")},FamilyTree._getTransform=function(e){var t=e.getAttribute("transform");return t=t.replace("matrix","").replace("(","").replace(")",""
),
FamilyTree._browser().msie&&(t=t.replace(/ /g,",")
),
t="["+(t=FamilyTree._trim(t))+"]",t=JSON.parse(t)},FamilyTree.getScale=function(e,t,i,r,a,n,l,o){var s=1;if(e||r!==FamilyTree.match.boundary)if(e||r!==FamilyTree.match.width)if(e||r!==FamilyTree.match.height)if(e){var d,c;s=(d=t/e[2])>(c=i/e[3])?c:d}else s=r;else s=i/o;else s=t/l;else s=(d=t/l)>(c=i/o)?c:d;return s&&s>a&&(s=a
),
s&&s<n&&(s=n
),
s},FamilyTree.isObject=function(e){return e&&"object"==typeof e&&!Array.isArray(e)&&null!==e},FamilyTree.fileUploadDialog=function(e){var t=document.createElement("INPUT");t.setAttribute("type","file"
),
t.style.display="none",t.onchange=function(){var t=this.files[0];e(t)},document.body.appendChild(t
),
t.click()},FamilyTree.mergeDeep=function(e,t){if(FamilyTree.isObject(e)&&FamilyTree.isObject(t))for(var i in t)FamilyTree.isObject(t[i])?(e[i]||Object.assign(e,{[i]:{}}
),
FamilyTree.mergeDeep(e[i],t[i])):Object.assign(e,{[i]:t[i]});return e},FamilyTree._lblIsImg=function(e,t){return!(!e.nodeBinding||"string"!=typeof t||-1==t.indexOf("img")||!e.nodeBinding[t])},FamilyTree._getFistImgField=function(e){if(e.nodeBinding)for(var t in e.nodeBinding)if(-1!=t.indexOf("img"))return e.nodeBinding[t];return!1},FamilyTree._fieldIsImg=function(e,t){if(e.nodeBinding)for(var i in e.nodeBinding)if(e.nodeBinding[i]==t)return FamilyTree._lblIsImg(e,i);return!1},FamilyTree._guid=function(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},FamilyTree.htmlRipple=function(e){var t=document.createElement("style");t.type="text/css",t.innerHTML=" .bft-ripple-container {position: absolute; top: 0; right: 0; bottom: 0; left: 0; } .bft-ripple-container span {transform: scale(0);border-radius:100%;position:absolute;opacity:0.75;background-color:#fff;animation: bft-ripple 1000ms; }@-moz-keyframes bft-ripple {to {opacity: 0;transform: scale(2);}}@-webkit-keyframes bft-ripple {to {opacity: 0;transform: scale(2);}}@-o-keyframes bft-ripple {to {opacity: 0;transform: scale(2);}}@keyframes bft-ripple {to {opacity: 0;transform: scale(2);}}",document.head.appendChild(t);var i,r,a,n=document.createElement("div");n.className="bft-ripple-container",e.addEventListener("mousedown",(function(t){var i,r,a,n,l;return this,r=document.createElement("span"
),
a=this.offsetWidth,i=this.getBoundingClientRect(
),
l=t.pageX-i.left-a/2,n="top:"+(t.pageY-i.top-a/2)+"px; left: "+l+"px; height: "+a+"px; width: "+a+"px;",e.rippleContainer.appendChild(r
),
r.setAttribute("style",n)})
),
e.addEventListener("mouseup",(i=function(){for(;this.rippleContainer.firstChild;)this.rippleContainer.removeChild(this.rippleContainer.firstChild)},r=2e3,a=void 0,function(){var e,t;return t=this,e=arguments,clearTimeout(a
),
a=setTimeout((function(){return i.apply(t,e)}
),
r)})
),
e.rippleContainer=n,e.appendChild(n)},FamilyTree._moveToBoundaryArea=function(e,t,i,r){var a=t.slice(0);t[0]<i.left&&t[0]<i.right&&(a[0]=i.left>i.right?i.right:i.left
),
...
t[0]!==a[0]||t[1]!==a[1]?FamilyTree.animate(e,{viewBox:t},{viewBox:a},300,FamilyTree.anim.outPow,(function(){r&&r()})):r&&r()},FamilyTree.randomId=function(){return"_"+("0000"+(Math.random()*Math.pow(36,4)|0).toString(36)).slice(-4)},FamilyTree._getClientXY=function(e){return-1==e.type.indexOf("touch")?{x:e.clientX,y:e.clientY}:e.changedTouches.length?{x:e.changedTouches[0].clientX,y:e.changedTouches[0].clientY}:void 0},FamilyTree._getClientTouchesXY=function(e,t){return-1!=e.type.indexOf("touch")?e.touches.length<t+1?{x:null,y:null}:{x:e.touches[t].clientX,y:e.touches[t].clientY}:{x:e.clientX,y:e.clientY}},FamilyTree._getOffset=function(e,t){e&&(t.x+=e.offsetLeft,t.y+=e.offsetTop,FamilyTree._getOffset(e.offsetParent,t))},FamilyTree._getTopLeft=function(e){var t={x:0,y:0};return FamilyTree._getOffset(e,t
),
t},FamilyTree._getOffsetXY=function(e,t){if(-1==t.type.indexOf("touch"))return{x:t.offsetX,y:t.offsetY};if(t.touches.length){var i=FamilyTree._getTopLeft(e);return{x:t.touches[0].pageX-i.x,y:t.touches[0].pageY-i.y}}if(t.changedTouches.length){i=FamilyTree._getTopLeft(e);return{x:t.changedTouches[0].pageX-i.x,y:t.changedTouches[0].pageY-i.y}}},FamilyTree._pinchMiddlePointInPercent=function(e,t,i,r){var a=FamilyTree._getTopLeft(e
),
n=r.touches[0].pageX-a.x,l=r.touches[0].pageY-a.y,o=r.touches[1].pageX-a.x,s=r.touches[1].pageY-a.y;return[((n-o)/2+o)/(t/100
),
((l-s)/2+s)/(i/100)]},FamilyTree._browser=function(){var e=!!window.opr&&!!window.opr.addons||!!window.opera||navigator.userAgent.indexOf(" OPR/")>=0,t="undefined"!=typeof InstallTrigger,i=/constructor/i.test(window.HTMLElement)||"[object SafariRemoteNotification]"===(!window.safari||void 0!==window.safari&&safari.pushNotification).toString(
),
r=!!document.documentMode,a=!r&&!!window.StyleMedia,n=!(!window.chrome||!window.chrome.webstore&&!window.chrome.runtime);return{opera:e,firefox:t,safari:i,msie:r,edge:a,chrome:n,blink:(n||e)&&!!window.CSS}},FamilyTree._menuPosition=function(e,t,i){var r=e.getBoundingClientRect(
),
a=i.getBoundingClientRect(
),
n=t.getBoundingClientRect(
),
l=r.left-a.left,o=r.top-a.top;return r.top+n.height>a.top+a.height&&(o-=n.height
),
r.left-n.width<a.left&&(l+=n.width
),
{x:l,y:o}},FamilyTree._getTemplate=function(e,t,i){if(Array.isArray(e))for(var r=0;r<e.length;r++){var a=t[e[r]];if(a&&a.template)return a.template}return i},FamilyTree._getMin=function(e,t){if(e.tags&&e.tags.length&&t.tags)for(var i=0;i<e.tags.length;i++){var r=t.tags[e.tags[i]];if(r&&!0===r.min)return!0}return t.min},FamilyTree._getSubLevels=function(e,t){if(e&&e.length)for(var i=0;i<e.length;i++){var r=t[e[i]];if(r&&r.subLevels)return r.subLevels}return 0},FamilyTree._isHTML=function(e){var t=(new DOMParser).parseFromString(e,"text/html");return Array.from(t.body.childNodes).some((e=>1===e.nodeType))},FamilyTree._getTestDiv=function(){var e=document.getElementById("orgfamily_js_test_div");return e||((e=document.createElement("div")).id="orgfamily_js_test_div",e.style.position="fixed",e.style.top="-10000px",e.style.left="-10000px",document.body.appendChild(e)
),
e},FamilyTree._getLabelSize=function(e){var t=FamilyTree._getTestDiv();return t.innerHTML="<svg>"+e+"</svg>",t.querySelector("text").getBoundingClientRect()},FamilyTree.wrapText=function(e,t){var i=t.toLowerCase();if(-1==i.indexOf("<text"))return FamilyTree._escapeHtml(e);if(-1==i.indexOf(FamilyTree.attr.width))return FamilyTree._escapeHtml(e);if(-1!=i.indexOf("foreignobject"))return FamilyTree._escapeHtml(e);if(-1==t.indexOf(FamilyTree.attr.width))return FamilyTree._escapeHtml(e);if(FamilyTree.ESCAPE_HTML&&"string"==typeof str&&FamilyTree._isHTML(e))return FamilyTree._escapeHtml(e);if(!FamilyTree.ESCAPE_HTML&&FamilyTree._isHTML(e))return e;var r=FamilyTree._getTestDiv();t=t.replaceAll("{cw}",0
),
r.innerHTML="<svg>"+t+"</svg>";var a,n,l=(new DOMParser).parseFromString(t,"text/xml").getElementsByTagName("text")[0],o=parseFloat(l.getAttribute("x")
),
...
p="http://www.w3.org/2000/svg",h=r.getElementsByTagName("svg")[0].getElementsByTagName("text")[0];m||(m="ellipsis");var f=m.split("-");if(f.length>1&&(a=parseInt(m.split("-")[1]
),
f.length>2&&"ellipsis"==f[2]&&(n=!0)
),
!c)return FamilyTree._escapeHtml(e);if(c=parseFloat(c
),
o||(o=0
),
s||(s=0
...
"ellipsis"==m){h.removeChild(h.firstChild
),
h.textContent=e;for(var u=h.getComputedTextLength(
),
y=2;u>c;)h.textContent=e.substring(0,e.length-y
),
h.textContent+="...",u=h.getComputedTextLength(
),
y++;return y>2?`<title>${FamilyTree._escapeHtml(e)}</title>${h.textContent}`:FamilyTree._escapeHtml(e)}if(-1!=m.indexOf("multiline")){var g=e.split(" "
),
T=h.getBBox().height;h.textContent="";var b=document.createElementNS(p,"tspan"
),
v=document.createTextNode(g[0]);b.setAttributeNS(null,"x",o
),
...
h.appendChild(b);y=1;for(var F=1,x=1;x<g.length;x++){var _=b.firstChild.data.length;if(b.firstChild.data+=" "+g[x],b.getComputedTextLength()>c){if(b.firstChild.data=b.firstChild.data.slice(0,_
),
F++,a&&F>a){if(n&&h.children.length==a){var w=h.children[a-1].textContent;h.children[a-1].textContent=w.substring(0,w.length-3)+"..."}break}(b=document.createElementNS(p,"tspan")).setAttributeNS(null,"x",o
),
...
y++}}var k="";if(null!=h.innerHTML)k=h.innerHTML,h.innerHTML="";else{var S="";for(x=h.childNodes.length-1;x>=0;x--)S=XMLSerializer().serializeToString(h.childNodes[x])+S,h.removeChild(h.childNodes[x]);k=S}return k}},FamilyTree._downloadFile=function(e,t,i,r,a){var n=new Blob([t],{type:e});if(1==r){var l=URL.createObjectURL(n);window.open(l,"_blank").focus()}else if(navigator.msSaveBlob)navigator.msSaveBlob(n,i);else{var o=document.createElement("a");if(void 0!==o.download){l=URL.createObjectURL(n);o.setAttribute("href",l);var s=i;s.toLowerCase().endsWith(a.toLowerCase())||(s=s+"."+a
),
o.setAttribute("download",s
),
o.style.visibility="hidden",document.body.appendChild(o
),
o.click(
),
document.body.removeChild(o)}}},FamilyTree._getPosition=function(e,t,i,r){var a={x:t.x,y:t.y};if(null!=i&&(a.x=i
),
null!=r&&(a.y=i
),
e&&3==e.length){var n=e[0].indexOf(t.id);-1!=n&&null!=e[1][n].transform&&(null==i&&(a.x=e[1][n].transform[4]
),
null==r&&(a.y=e[1][n].transform[5]))}return a},FamilyTree._getOpacity=function(e,t){var i=1;if(e&&3==e.length){var r=e[0].indexOf(t.id);-1!=r&&null!=e[1][r].opacity&&(i=e[1][r].opacity)}return i},FamilyTree.t=function(e,t,i){var r=FamilyTree.templates[e];null==r&&console.error(`Template "${e}" does not exist!`);var a=null;if(null!=i&&r.scaleLessThen){var n=[];for(var l in r.scaleLessThen){var o=parseFloat(l);i<o&&n.push(o)}if(n.length>0){n.sort((function(e,t){return e-t}));var s=r.scaleLessThen[n[0]];for(var d in s)null==a&&(a=Object.assign({},r)
),
a[d]=s[d]}}return t?null==a?r.min?r.min:r:a.min?a.min:a:null==a?r:a},FamilyTree.setNodeSize=function(e){var t=FamilyTree.t(e.templateName,e.min);e.w=t&&t.size?t.size[0]:0,e.h=t&&t.size?t.size[1]:0},FamilyTree._imgs2base64=function(e,t,i,r){var a=e.getElementsByTagName(t
),
n=a.length;0==n&&r();for(var l=0;l<n;l++)!function(){var e=l,t=a[e];FamilyTree._getDataUri(t.getAttribute(i
),
(function(a){a.success&&t.setAttribute(i,a.result
),
e==n-1&&r()}))}()},FamilyTree._getDataUri=function(e,t){if(-1!=e.indexOf("base64"))t({success:!1});else{var i=new XMLHttpRequest;i.open("GET",e
),
...
e},FamilyTree.prototype._export=function(e,t){var i=this,r={id:e.nodeId,expandChildren:e.expandChildren,min:e.min};e.margin&&e.margin[0]<2&&(e.margin[0]=2
),
...
this._draw(!1,FamilyTree.action.exporting,r,(function(r){var a=document.createElement("div");if(a.innerHTML=r,e.padding>0){var n=a.querySelector("svg"
),
l=FamilyTree._getViewBox(n);l[0]-=e.padding,l[1]-=e.padding,l[2]+=2*e.padding,l[3]+=2*e.padding,n.setAttribute("viewBox",l.join()
),
n.setAttribute("width",l[2]
),
n.setAttribute("height",l[3])}if("svg"==e.ext)if(t)t(e,a.innerHTML);else{(n=a.querySelector("svg")).classList.add("bft-"+i.config.mode);var o={content:a.innerHTML,options:e,styles:""},s=FamilyTree.events.publish("exportstart",[i,o]
),
d=i.element.querySelector("[data-bft-styles]");if(d&&(o.styles+=d.outerHTML
),
o.styles&&(a.childNodes[0].insertAdjacentHTML("afterbegin",o.styles
),
o.content=a.innerHTML
),
!1===s)return!1;if(!1===(s=FamilyTree.events.publish("exportend",[i,o])))return!1;FamilyTree._downloadFile(e.mime,o.content,o.options.filename,o.options.openInNewTab,o.options.ext)}else i._pages(e,a.querySelector("svg"
),
(function(r){var n={content:a.innerHTML,options:e,pages:r,styles:""},l=FamilyTree.events.publish("exportstart",[i,n]
),
o=i.element.querySelector("[data-bft-styles]");if(o&&(n.styles+=o.outerHTML
),
!1===l)return!1;t||FamilyTree.loading.show(i
),
t?t(i,n,a.querySelector("svg")):(n=JSON.stringify(n
),
FamilyTree._ajax(i.config.exportUrl+"/v3","POST",n,"arraybuffer",(function(t){var r=FamilyTree.events.publish("exportend",[i,t]);if(FamilyTree.loading.hide(i
),
!1===r)return!1;FamilyTree._downloadFile(e.mime,t,e.filename,e.openInNewTab,e.ext)})))}))}))},FamilyTree.prototype.exportCSV=function(e){e||(e="FamilyTree.csv");var t={ext:"csv",filename:e,nodes:JSON.parse(JSON.stringify(this.config.nodes))};if(!1===FamilyTree.events.publish("exportstart",[this,t]))return!1;var i=FamilyTree._json2csv(t.nodes
),
r={ext:t.ext,filename:t.filename,nodes:t.nodes,content:i};if(!1===FamilyTree.events.publish("exportend",[this,r]))return!1;FamilyTree._downloadFile("text/csv;charset=utf-8;","\ufeff"+r.content,r.filename,r.openInNewTab,r.ext)},FamilyTree.prototype.exportXML=function(e){e||(e="FamilyTree.xml");var t={ext:"xml",filename:e,nodes:JSON.parse(JSON.stringify(this.config.nodes))};if(!1===FamilyTree.events.publish("exportstart",[this,t]))return!1;var i=FamilyTree._json2xml(t.nodes
),
r={ext:t.ext,filename:t.filename,nodes:t.nodes,content:i};if(!1===FamilyTree.events.publish("exportend",[this,r]))return!1;FamilyTree._downloadFile("application/xml",r.content,r.filename,r.openInNewTab,r.ext)},FamilyTree.prototype.exportJSON=function(e){e||(e="FamilyTree.json");var t={ext:"json",filename:e,nodes:JSON.parse(JSON.stringify(this.config.nodes))};if(!1===FamilyTree.events.publish("exportstart",[this,t]))return!1;var i={ext:t.ext,filename:t.filename,nodes:t.nodes,content:JSON.stringify(t.nodes)};if(!1===FamilyTree.events.publish("exportend",[this,i]))return!1;FamilyTree._downloadFile("application/json",i.content,i.filename,i.openInNewTab,i.ext)},FamilyTree.prototype._pages=function(e,t,i){"A5"==e.format&&"fit"!=e.scale||"A4"==e.format&&"fit"!=e.scale||"A3"==e.format&&"fit"!=e.scale||"A2"==e.format&&"fit"!=e.scale||"A1"==e.format&&"fit"!=e.scale||"Letter"==e.format&&"fit"!=e.scale||"Legal"==e.format&&"fit"!=e.scale?i(this._pagesA100(e,t,e.scale)):"A5"==e.format&&"fit"==e.scale||"A4"==e.format&&"fit"==e.scale||"A3"==e.format&&"fit"==e.scale||"A2"==e.format&&"fit"==e.scale||"A1"==e.format&&"fit"==e.scale||"Letter"==e.format&&"fit"==e.scale||"Legal"==e.format&&"fit"==e.scale?i(this._pagesAfit(e,t)):"fit"==e.format&&i(this._pagesFit(e,t))},FamilyTree.prototype._pagesFit=function(e,t){var i=t.getAttribute("width"
),
...
h:parseFloat(r)};return[{vb:a,size:{w:n.w+(e.margin[1]+e.margin[3]
),
h:n.h+(e.margin[0]+e.margin[2])},innerSize:n}]},FamilyTree.prototype._pagesAfit=function(e,t){var i=t.getAttribute("width"
),
r=0,a=0;switch(e.format){case"A5":r=FamilyTree.A5w,a=FamilyTree.A5h;break;case"A4":r=FamilyTree.A4w,a=FamilyTree.A4h;break;case"A3":r=FamilyTree.A3w,a=FamilyTree.A3h;break;case"A2":r=FamilyTree.A2w,a=FamilyTree.A2h;break;case"A1":r=FamilyTree.A1w,a=FamilyTree.A1h;break;case"Letter":r=FamilyTree.Letterw,a=FamilyTree.Letterh;break;case"Legal":r=FamilyTree.Legalw,a=FamilyTree.Legalh}var n=e.landscape?a-(e.margin[1]+e.margin[3]):r-(e.margin[1]+e.margin[3]
),
l=(e.landscape?(e.margin[0],e.margin[2]):(e.margin[0],e.margin[2]
),
n/i);return this._pagesA100(e,t,100*l)},FamilyTree.prototype._pagesA100=function(e,t,i){var r=FamilyTree._getViewBox(t
),
a=0,n=0;switch(e.format){case"A5":a=FamilyTree.A5w,n=FamilyTree.A5h;break;case"A4":a=FamilyTree.A4w,n=FamilyTree.A4h;break;case"A3":a=FamilyTree.A3w,n=FamilyTree.A3h;break;case"A2":a=FamilyTree.A2w,n=FamilyTree.A2h;break;case"A1":a=FamilyTree.A1w,n=FamilyTree.A1h;break;case"Letter":a=FamilyTree.Letterw,n=FamilyTree.Letterh;break;case"Legal":a=FamilyTree.Legalw,n=FamilyTree.Legalh}var l=r[0],o=r[1],s=r[2],d=r[3],c={w:e.landscape?n-(e.margin[1]+e.margin[3]):a-(e.margin[1]+e.margin[3]
),
h:e.landscape?a-(e.margin[0]+e.margin[2]):n-(e.margin[0]+e.margin[2])},m={w:e.landscape?n:a,h:e.landscape?a:n};t.setAttribute("preserveAspectRatio","xMinYMin slice"
),
t.setAttribute("width",c.w
),
t.setAttribute("height",c.h);for(var p=c.w*(100/i
),
h=c.h*(100/i
),
f=l,u=o,y=[];f<s+l;){for(;u<d+o;){var g=[f,u,p,h];g=g.join(
),
y.push({vb:g,innerSize:c,size:m}
),
u+=h}f+=p,u=o}return y},FamilyTree.prototype._defaultExportProfileOptions=function(e,t){return(FamilyTree.isNEU(e)||FamilyTree.isNEU(e.id))&&console.error("options.id is not defilned"
),
"svg"==t?(e.ext="svg",e.mime="image/svg+xml"):"pdf"==t?(e.mime="application/pdf",e.ext="pdf"):"png"==t&&(e.mime="image/png",e.ext="png"
),
null==e.margin&&(e.margin=[50,40,50,40]
...
e},FamilyTree.prototype._exportProfile=function(e,t){var i=this,r=0,a=0;switch(e.format){case"A5":r=FamilyTree.A5w,a=FamilyTree.A5h;break;case"A4":r=FamilyTree.A4w,a=FamilyTree.A4h;break;case"A3":r=FamilyTree.A3w,a=FamilyTree.A3h;break;case"A2":r=FamilyTree.A2w,a=FamilyTree.A2h;break;case"A1":r=FamilyTree.A1w,a=FamilyTree.A1h;break;case"Letter":r=FamilyTree.Letterw,a=FamilyTree.Letterh;break;case"Legal":r=FamilyTree.Legalw,a=FamilyTree.Legalh}var n={w:e.landscape?a-(e.margin[1]+e.margin[3]):r-(e.margin[1]+e.margin[3]
),
h:e.landscape?r-(e.margin[0]+e.margin[2]):a-(e.margin[0]+e.margin[2])},l={w:e.landscape?a:r,h:e.landscape?r:a},o=this.editUI.content(e.id,!0,!0,"100%",!0).element;FamilyTree.input.init(o);var s={content:o.outerHTML,options:e,pages:[{vb:"",innerSize:n,size:l}],styles:""};if(!t){if(!1===FamilyTree.events.publish("exportstart",[i,s]))return!1;FamilyTree.loading.show(i)}var d=this.element.querySelector("[data-bft-styles]");d&&(s.styles+=d.outerHTML);var c=this.getSvg().querySelector("defs");if(c)for(var m=0;m<c.children.length;m++)"style"==c.children[m].nodeName.toLowerCase()&&(s.styles+=c.children[m].outerHTML);s=JSON.stringify(s
),
FamilyTree._ajax(this.config.exportUrl+"/v3","POST",s,"arraybuffer",(function(r){if(t)t(i,r);else{var a=FamilyTree.events.publish("exportend",[i,r]);if(FamilyTree.loading.hide(i
),
!1===a)return!1;FamilyTree._downloadFile(e.mime,r,e.filename,e.openInNewTab,e.ext)}}))},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree.events=function(){var e={};return{on:function(t,i,r){Array.isArray(e[t])||(e[t]=[]
),
e[t].push({listener:i,event_id:r})},removeAll:function(t){Array.isArray(e[t])||(e[t]=[]
),
e[t]=[]},has:function(t,i){if(e[t]&&Array.isArray(e[t])&&e[t].length>0){if(FamilyTree.isNEU(i))return!0;for(var r=0;r<e[t].length;r++)if(e[t][r].event_id==i)return!0}return!1},removeForEventId:function(t){for(var i in e)if(Array.isArray(e[i]))for(var r=e[i].length-1;r>=0;r--)e[i][r].event_id==t&&e[i].splice(r,1)},publish:function(t,i){if(e[t]){for(var r=[],a=0;a<e[t].length;a++){var n=e[t][a];null!=n.event_id&&n.event_id!=i[0]._event_id||r.push(n.listener)}if(r.length>0){var l=!0;for(a=0;a<r.length&&(1==i.length?l=r[a](i[0])&&l:2==i.length?l=r[a](i[0],i[1])&&l:3==i.length?l=r[a](i[0],i[1],i[2])&&l:4==i.length?l=r[a](i[0],i[1],i[2],i[3])&&l:5==i.length&&(l=r[a](i[0],i[1],i[2],i[3],i[4])&&l
),
!1!==l);a++);return l}}}}}(
),
FamilyTree.prototype.importCSV=function(){var e=this,t=document.createElement("INPUT");t.setAttribute("type","file"
),
t.setAttribute("accept",".csv"
),
t.style.display="none",t.onchange=function(t){var i=t.target,r=new FileReader;r.onload=function(){var t=r.result,i=FamilyTree._csvToArray(t
),
a=[],n=i[0];FamilyTree._importSetColumnNames(n,(function(t){for(var r=1;r<i.length;r++){for(var n={},l=0;l<i[r].length;l++){var o=t[l],s=i[r][l];n[o]=FamilyTree._convertStringToArray(o,s)}""!=n.id.trim()&&a.push(n)}var d={nodes:a,columnNames:i[0]};0!=FamilyTree.events.publish("import",[e,d])&&(e.config.nodes=d.nodes,e.draw())}))},r.readAsText(i.files[0])},t.click()},FamilyTree._importSetColumnNames=function(e,t){if(-1==e.indexOf("id")||-1==e.indexOf("pid")){var i=document.createElement("DIV"
),
r=document.createElement("P");r.style.padding="5px",r.style.color="rgb(122, 122, 122)",r.innerHTML=FamilyTree.IMPORT_MESSAGE,i.appendChild(r);var a=document.createElement("div"
),
n=document.createElement("div"
),
l=document.createElement("div"
),
o=document.createElement("span");a.setAttribute("id","bft-sampleDialog"
),
a.style.height="260px",a.style.width="400px",a.style.background="white",a.style.border="0.5px solid grey",a.style.position="fixed",a.style.overflow="hidden",a.style.zIndex="99",n.setAttribute("id","title"
),
n.style.backgroundColor="#e5e5e5",n.style.fontWeight="bold",n.style.color="rgb(122, 122, 122)",n.style.height="20px",n.style.padding="3px 0 0 7px",o.setAttribute("id","close"
),
o.style.cursor="pointer",o.style.position="absolute",o.style.color="rgb(122, 122, 122)",o.style.fontWeight="bold",o.style.top="2px",o.style.zIndex=100,l.setAttribute("id","content"
),
l.style.padding="2px",n.innerHTML="Import Organizational Chart Data",o.innerHTML="&times;";var s=document.createElement("HR");s.style.height="0.1px",s.style.backgroundColor="#aeaeae",s.style.border="none",s.style.margin="0",a.appendChild(n
),
a.appendChild(s
),
l.appendChild(i
...
o.style.left=a.offsetWidth-20+"px";var d=document.createElement("div");d.setAttribute("id","overlay"
),
d.style.width="100%",d.style.height="100%",d.style.left=0,d.style.top=0,d.style.position="fixed",d.style.background="grey",d.style.opacity="0.5",d.style.zIndex=98,document.body.appendChild(d
),
a._overlay=d;var c=document.createElement("LABEL"
),
m=document.createTextNode("Name:");c.setAttribute("for","bft-id-select"
),
c.appendChild(m
),
c.style.fontSize="16px",c.style.color="rgb(122, 122, 122)",c.style.padding="5px",c.style.margin="5px",c.style.width="30%",c.style.textAlign="right",c.style.display="inline-block",i.appendChild(c);var p=document.createElement("SELECT");p.id="bft-id-select",p.style.fontSize="16px",p.style.color="rgb(122, 122, 122)",p.style.padding="5px",p.style.margin="5px",p.style.width="60%",p.style.border="1px solid #aeaeae",i.appendChild(p);var h=document.createElement("BR");i.appendChild(h);for(var f=0;f<e.length;f++){(b=document.createElement("option")).setAttribute("value",e[f]);var u=document.createTextNode(e[f]);b.appendChild(u
),
p.appendChild(b)}var y=document.createElement("LABEL"
),
g=document.createTextNode("Reports to:");y.setAttribute("for","pid-select"
),
y.appendChild(g
),
...
T.appendChild(b)}var v=document.createElement("BUTTON");v.innerHTML="Import",v.style.fontSize="16px",v.style.color="rgb(122, 122, 122)",v.style.padding="5px 20px",v.style.margin="20px auto",v.style.display="block",v.onclick=function(){a.style.display="none",a._overlay&&a._overlay.parentNode.removeChild(a._overlay);var i=p.options[p.selectedIndex].value,r=e.indexOf(i);e[r]="id";var n=T.options[T.selectedIndex].value,l=e.indexOf(n);e[l]="pid",t(e)};var F=document.createElement("DIV");return F.appendChild(v
),
i.appendChild(F
),
o.onclick=function(e){a._overlay&&a._overlay.parentNode.removeChild(a._overlay
),
a.parentNode.removeChild(a
),
e.stopPropagation()},n.onmousedown=function(e){e=e||window.event,a._dragging=!0,a._originalLeft=a.offsetLeft,a._originalTop=a.offsetTop,a._mouseLeft=e.clientX,a._mouseTop=e.clientY},document.onmousemove=function(e){e=e||window.event,a._dragging&&(a.style.left=a._originalLeft+e.clientX-a._mouseLeft+"px",a.style.top=a._originalTop+e.clientY-a._mouseTop+"px")},document.onmouseup=function(e){e=e||window.event,a._dragging&&(a.style.left=a._originalLeft+e.clientX-a._mouseLeft+"px",a.style.top=a._originalTop+e.clientY-a._mouseTop+"px",a._dragging=!1)},a}t(e)},FamilyTree._importCenter=function(e){e&&(e.style.left=(window.innerWidth-e.offsetWidth)/2+"px",e.style.top=(window.innerHeight-e.offsetHeight)/2+"px")},FamilyTree.prototype.importXML=function(){var e=this,t=document.createElement("INPUT");t.setAttribute("type","file"
),
t.setAttribute("accept",".xml"
),
t.style.display="none",t.onchange=function(t){var i=t.target,r=new FileReader;r.onload=function(){var t=r.result,i=FamilyTree._xml2json(t);0!=FamilyTree.events.publish("import",[e,i])&&(e.config.nodes=i,e.draw())},r.readAsText(i.files[0])},t.click()},FamilyTree.prototype.importJSON=function(){var e=this,t=document.createElement("INPUT");t.setAttribute("type","file"
),
t.setAttribute("accept",".json"
),
t.style.display="none",t.onchange=function(t){var i=t.target,r=new FileReader;r.onload=function(){var t=r.result,i=JSON.parse(t);0!=FamilyTree.events.publish("import",[e,i])&&(e.config.nodes=i,e.draw())},r.readAsText(i.files[0])},t.click()},FamilyTree._importSetColumnNames=function(e,t){t(e)},FamilyTree.prototype.expand=function(e,t,i){var r={id:e,ids:t};this._draw(!1,FamilyTree.action.expand,r,i)},FamilyTree.prototype.collapse=function(e,t,i){var r={id:e,ids:t};this._draw(!1,FamilyTree.action.collapse,r,i)},FamilyTree.prototype.expandCollapse=function(e,t,i,r){Array.isArray(t)||(t=[]
),
Array.isArray(i)||(i=[]);var a={id:e,expandIds:t,collapseIds:i,ids:t.concat(i)};this._draw(!1,FamilyTree.action.collapse,a,r)},FamilyTree.prototype.changeRoots=function(e,t,i){this.config.roots=t;var r={id:e,changeRoots:t};this._draw(!1,FamilyTree.action.update,r,i)},FamilyTree.prototype.maximize=function(e,t,i,r){var a=this,n={id:e,options:{}};FamilyTree.isNEU(n.id)&&(n.id=this.roots[0].id,n.all=!0
),
n.options.horizontal=!1,n.options.vertical=!1,t&&(n.options.horizontal=t
),
i&&(n.options.vertical=i
),
this._draw(!1,FamilyTree.action.maximize,n,(function(){a.ripple(e
),
r&&r()}))},FamilyTree.prototype.minimize=function(e,t){var i=this,r={id:e};FamilyTree.isNEU(r.id)&&(r.id=this.roots[0].id,r.all=!0
),
this._draw(!1,FamilyTree.action.minimize,r,(function(){i.ripple(e
),
t&&t()}))},FamilyTree.prototype._expCollHandler=function(e){this.nodeMenuUI.hide(
),
this.nodeContextMenuUI.hide(
),
this.menuUI.hide(
),
this.nodeCircleMenuUI.hide();var t=this.getNode(e
),
i=this.getCollapsedIds(t);if(i.length){if(!1===FamilyTree.events.publish("expcollclick",[this,!1,e,i]))return!1;this.expand(e,i,!1)}else{if(!1===FamilyTree.events.publish("expcollclick",[this,!0,e,t.childrenIds]))return!1;this.collapse(e,t.childrenIds,!1)}},FamilyTree.prototype._upHandler=function(e){this.nodeMenuUI.hide(
),
this.nodeContextMenuUI.hide(
),
this.menuUI.hide(
),
this.nodeCircleMenuUI.hide();var t=this._upHandlerCreateArgs(e);if(!1===FamilyTree.events.publish("up-click",[this,t]))return!1;this.changeRoots(t.id,t.roots,!1)},FamilyTree.prototype._upHandlerCreateArgs=function(e){var t,i=this.getNode(e
),
r=Object.assign([],this.config.roots
),
a=this.getNode(i.pid);if(a&&(t=a
),
t){if(Array.isArray(r)){var n=r.indexOf(i.id);-1!=n&&r.splice(n,1)}else r=[];r.push(t.id)}return{id:i.id,roots:r}},FamilyTree.prototype._upHandlerCreateArgs=function(e){var t=this.getNode(e
),
i=Object.assign([],this.config.roots
),
r=this.getRecentRootsByNodeId(e);return Array.isArray(i)||(i=[]
),
FamilyTree._changeRootOption(i,r,this.manager.rootList
),
{id:t.id,roots:i}},String.prototype.replaceAll||(String.prototype.replaceAll=function(e,t){return this.replace(new RegExp(e,"g"
),
t)}
),
String.prototype.endsWith||(String.prototype.endsWith=function(e){return-1!==this.indexOf(e,this.length-e.length)}
),
String.prototype.splice||(String.prototype.splice=function(e,t,i){return this.slice(0,e)+i+this.slice(e+Math.abs(t))}
),
String.prototype.insert||(String.prototype.insert=function(e,t){return e>0?this.substring(0,e)+t+this.substr(e):t+this}
),
Array.prototype.unique||Object.defineProperty(Array.prototype,"unique",{value:function(){for(var e=this.concat(
),
t=0;t<e.length;++t)for(var i=t+1;i<e.length;++i)e[t]===e[i]&&e.splice(i--,1);return e},writable:!0,configurable:!0,enumerable:!1}
),
Array.prototype.has||Object.defineProperty(Array.prototype,"has",{value:function(e){for(var t=0;t<this.length;t++)if(this[t]==e)return!0;return!1},writable:!0,configurable:!0,enumerable:!1}
),
Array.prototype.compare||Object.defineProperty(Array.prototype,"compare",{value:function(e){if(this.length!=e.length)return!1;for(var t=0;t<this.length;t++)if(!e.has(this[t]))return!1;return!0},writable:!0,configurable:!0,enumerable:!1}
),
Object.assign||Object.defineProperty(Object,"assign",{value:function(e,t){"use strict";if(null==e)throw new TypeError("Cannot convert undefined or null to object");for(var i=Object(e
),
r=1;r<arguments.length;r++){var a=arguments[r];if(null!=a)for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(i[n]=a[n])}return i},writable:!0,configurable:!0}
),
FamilyTree.prototype._globalMouseDownHandler=function(e,t){var i={move:"mousemove",up:"mouseup",leave:"mouseleave"};if(-1!=t.type.indexOf("touch")&&(1==t.touches.length?this._touch={x:t.touches[0].clientX,y:t.touches[0].clientY}:this._touch=null,i={move:"touchmove",up:"touchend",touchstart:"touchstart"}
),
e==t.target)return t.stopPropagation(
),
t.preventDefault(
),
void this._mouseDownHandler(e,t,i);if(this.config.nodeMouseClick==FamilyTree.action.pan){for(var r=t.target;r!=e&&!r.hasAttribute(FamilyTree.attr.control_expcoll_id)&&!r.hasAttribute(FamilyTree.attr.control_up_id);)r=r.parentNode;if(!r.hasAttribute(FamilyTree.attr.control_expcoll_id)&&!r.hasAttribute(FamilyTree.attr.control_up_id))return t.stopPropagation(
),
t.preventDefault(
),
void this._mouseDownHandler(e,t,i)}for(var a=t.target;a!=e;){if(a.hasAttribute(FamilyTree.attr.node_id))return void this._nodeMouseDownHandler(a,t,i);if(a.hasAttribute(FamilyTree.attr.control_node_circle_menu_name))return t.stopPropagation(
),
t.preventDefault(
),
void this._nodeCircleNodeMenuItemMouseDownHandler(a,t,i);a=a.parentNode}},FamilyTree.prototype._globalClickHandler=function(e,t){if(-1!=t.type.indexOf("touch")&&this._touch&&1==t.changedTouches.length){if(t.changedTouches.length){var i={x:t.changedTouches[0].clientX,y:t.changedTouches[0].clientY},r=FamilyTree.t(this.config.template,!1,this.getScale()).size,a=this.getScale(
),
n=Math.abs(i.x-this._touch.x)/a,l=Math.abs(i.y-this._touch.y)/a;if(this._touch=null,n>r[0]/10)return;if(l>r[1]/10)return}}else if(-1!=t.type.indexOf("touch")&&null==this._touch)return;for(var o=t.target;o!=e;){if(o.hasAttribute(FamilyTree.attr.control_expcoll_id)){var s=o.getAttribute(FamilyTree.attr.control_expcoll_id
),
d=this.getNode(s);return void this._expCollHandler(d.id)}if(o.hasAttribute(FamilyTree.attr.node_id)){s=o.getAttribute(FamilyTree.attr.node_id
),
d=this.getNode(s);return void this._nodeClickHandler(d.id,t)}if(o.hasAttribute(FamilyTree.attr.control_node_menu_id)){t.stopPropagation(
),
t.preventDefault();s=o.getAttribute(FamilyTree.attr.control_node_menu_id
),
d=this.getNode(s);return void this._nodeMenuClickHandler(d.id,o,t)}if(o.hasAttribute(FamilyTree.attr.control_node_circle_menu_id)){t.stopPropagation(
),
t.preventDefault();s=o.getAttribute(FamilyTree.attr.control_node_circle_menu_id);return void this._nodeCircleMenuClickHandler(s)}if(o.hasAttribute(FamilyTree.attr.control_node_circle_menu_name))return t.stopPropagation(
),
t.preventDefault(
),
void this._nodeCircleMenuItemClickHandler(o,t);if(o.hasAttribute(FamilyTree.attr.control_add))return void this._lonelyButtonHandler();if(o.hasAttribute(FamilyTree.attr.control_up_id)){s=o.getAttribute(FamilyTree.attr.control_up_id);return t.stopPropagation(
),
t.preventDefault(
),
void this._upHandler(s)}if(o.hasAttribute(FamilyTree.attr.c_link_from))return void FamilyTree.events.publish("clink-click",[this,{from:o.getAttribute(FamilyTree.attr.c_link_from
),
to:o.getAttribute(FamilyTree.attr.c_link_to
),
event:t}]);if(o.hasAttribute(FamilyTree.attr.s_link_from))return void FamilyTree.events.publish("slink-click",[this,{from:o.getAttribute(FamilyTree.attr.s_link_from
),
to:o.getAttribute(FamilyTree.attr.s_link_to
),
event:t}]);o=o.parentNode}},FamilyTree.prototype._globalContextHandler=function(e,t){for(var i=t.target;i!=e;){if(i.hasAttribute(FamilyTree.attr.node_id)){var r=i.getAttribute(FamilyTree.attr.node_id
),
a=this.getNode(r);return void this._nodeContextHandler(a.id,t)}i=i.parentNode}},FamilyTree.prototype._nodeContextHandler=function(e,t){t.preventDefault(
),
...
this.nodeCircleMenuUI.hide();var i=this.get(e
),
r=null;if(null!=i&&Array.isArray(i.tags))for(var a=0;a<i.tags.length;a++){var n=i.tags[a];this.config.tags[n]&&this.config.tags[n].nodeContextMenu&&(r=this.config.tags[n].nodeContextMenu)}var l=this.element.getBoundingClientRect(
),
o=t.clientX-l.left,s=t.clientY-l.top;this.nodeContextMenuUI.show(o,s,e,null,r)},FamilyTree.prototype._globalDbClickHandler=function(e,t){for(var i=t.target;i!=e;){if(i.hasAttribute(FamilyTree.attr.node_id)){var r=i.getAttribute(FamilyTree.attr.node_id
),
a=this.getNode(r);return void this._nodeDbClickHandler(a.id,t)}i=i.parentNode}},FamilyTree.prototype._mouseScrollHandler=function(e,t){this.__mouseScrollHandler(this.getSvg(
),
t)},FamilyTree.prototype.__mouseScrollHandler=function(e,t){if(this.config.mouseScrool!=FamilyTree.action.ctrlZoom||t.ctrlKey){var i=this,r=!1,a=this.config.zoom.speed,n=this.config.zoom.smooth,l=0,o=this.getScale(
),
s=FamilyTree._centerPointInPercent(e,t.pageX,t.pageY
),
d=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(e){setTimeout(e,20)};t.preventDefault();var c=t.delta||t.wheelDelta;void 0===c&&(c=-t.detail
),
c=Math.max(-1,Math.min(1,c)
),
l+=-c*a,r||function e(){r=!0;var t=(l-o)/n;t>0?t++:t--,o+=t,i.zoom(1-t/12/50,s
),
parseInt(o)==parseInt(l)?r=!1:d(e)}()}},FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler=function(e,t,i){var r=e.parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id
),
a=e.getAttribute(FamilyTree.attr.control_node_circle_menu_name
),
n=this.nodeCircleMenuUI._menu[a];if(n.draggable){var l=this,o=FamilyTree._getClientXY(t
),
s=this.getNode(r);e._dragEventFired=!1;var d=l.getScale(
),
c=null,m=null;this._gragStartedId=r,document.body.style.mozUserSelect=document.body.style.webkitUserSelect=document.body.style.userSelect="none";var p=this.getSvg(
),
h={x:o.x,y:o.y},f=e.cloneNode(!0);p.insertBefore(f,p.firstChild);var u=FamilyTree._getTransform(f
),
y=u[4],g=u[5],T=function(e){for(;e&&!e.hasAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id);)e=e.parentNode;if(e){var t=FamilyTree._getTransform(e);return{x:t[4],y:t[5]}}console.error("cannot find parent"+FamilyTree.attr.control_node_circle_menu_wrraper_id)}(e);f.setAttribute("transform","matrix(1,0,0,1,"+(y+T.x)+","+(g+T.y)+")"
),
f.style.opacity=.7;var b=function(e,t){if(null!=e){t.classList.remove("bft-drag-over");for(var i=FamilyTree.getStParentNodes(l.getNode(c)
),
r=0;r<i.length;r++){var a=l.getNodeElement(i[r].id);a&&(a.style.opacity=1)}}},v=function(t){if(h){var i=FamilyTree._getClientXY(t
),
r=t.target;FamilyTree.isMobile()&&(r=document.elementFromPoint(i.x,i.y)
),
i.x+=T.x*d,i.y+=T.y*d;var o=FamilyTree._getOffsetXY(l.element,t
),
s={left:l.width()-(o.x+l.config.padding)<0,right:o.x-l.config.padding<0,down:l.height()-(o.y+l.config.padding)<0,up:o.y-l.config.padding<0};if(s.left||s.right||s.up||s.down){p.classList&&(p.classList.remove("bft-cursor-grab"
),
p.classList.add("bft-cursor-move"
),
p.classList.remove("bft-cursor-nodrop"
),
p.classList.remove("bft-cursor-copy"));var v=u[4],x=u[5],_=h.x,w=h.y,k=i.x,S=i.y;l.startMove(s,(function(e){u[4]=v+e.x,u[5]=x+e.y,h.x=_-e.xWithoutScale,h.y=w-e.yWithoutScale,i.x=k-e.xWithoutScale,i.y=S-e.yWithoutScale,f.setAttribute("transform","matrix("+u.toString()+")")}))}else{for(l.stopMove(
),
...
c=null,m=null;null!=r&&r!=p;){if(r.hasAttribute&&r.hasAttribute(FamilyTree.attr.node_id)){var C=r.getAttribute(FamilyTree.attr.node_id);c=C,m=r;break}r=r.parentNode}if(null!=c){m.classList.add("bft-drag-over");for(var I=l.getNode(c
),
A=FamilyTree.getStParentNodes(I
),
N=0;N<A.length;N++){var M=l.getNodeElement(A[N].id);M&&(M.style.opacity=.1)}p.classList.remove("bft-cursor-grab"
),
p.classList.remove("bft-cursor-move"
),
p.classList.add("bft-cursor-copy"
),
p.classList.remove("bft-cursor-nodrop")}var E=(i.x-h.x)/d,L=(i.y-h.y)/d;if(u[4]=y+E,u[5]=g+L,!e._dragEventFired&&(Math.abs(i.x-h.x)>FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE||Math.abs(i.y-h.y)>FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE))!1===FamilyTree.events.publish("drag",[l.nodeCircleMenuUI,{from:C,menuItem:n,menuItemName:a}])&&F(
),
e._dragEventFired=!0;f.setAttribute("transform","matrix("+u.toString()+")")}}},F=function(t){if(l.stopMove(
),
...
s.id==c||null==c)return p.removeChild(f
),
l._gragStartedId=null,void(e._dragEventFired&&FamilyTree.events.publish("drop",[l.nodeCircleMenuUI,{from:s.id,menuItemName:a,menuItem:n}]));var r=l.getNode(c);FamilyTree.events.publish("drop",[l.nodeCircleMenuUI,{from:s.id,to:r.id,menuItem:n,menuItemName:a}]
),
b(c,m
),
p.removeChild(f
),
l._gragStartedId=null};p.addEventListener(i.move,v
),
p.addEventListener(i.up,F
),
i.leave&&p.addEventListener(i.leave,F)}},FamilyTree.prototype._nodeMouseDownHandler=function(e,t,i){if(this.config.enableDragDrop){var r=FamilyTree._getClientXY(t
),
a=e.getAttribute(FamilyTree.attr.node_id
),
n=this.getNode(a);e._dragEventFired=!1;var l=null,o=null;this._gragStartedId=a,document.body.style.mozUserSelect=document.body.style.webkitUserSelect=document.body.style.userSelect="none";var s=this,d=this.getSvg(
),
c={x:r.x,y:r.y},m=FamilyTree._getTransform(e
),
p=m[4],h=m[5],f=s.getScale(
),
u=e.cloneNode(!0);u.setAttribute("data-n-id","draging"
),
d.insertBefore(u,d.firstChild
),
u.style.opacity=.7;var y=function(e,t){if(null!=e){t.classList.remove("bft-drag-over");for(var i=s.getNode(l
),
r=FamilyTree.getStParentNodes(i
),
a=0;a<r.length;a++){var n=s.getNodeElement(r[a].id);n&&(n.style.opacity=1)}}},g=function(t){if(c){var i=FamilyTree._getClientXY(t
),
r=t.target;FamilyTree.isMobile()&&(r=document.elementFromPoint(i.x,i.y));var a=FamilyTree._getOffsetXY(s.element,t
),
g={left:s.width()-(a.x+s.config.padding)<0,right:a.x-s.config.padding<0,down:s.height()-(a.y+s.config.padding)<0,up:a.y-s.config.padding<0};if(g.left||g.right||g.up||g.down){d.classList&&(d.classList.remove("bft-cursor-grab"
),
d.classList.add("bft-cursor-move"
),
d.classList.remove("bft-cursor-nodrop"
),
d.classList.remove("bft-cursor-copy"));var b=m[4],v=m[5],F=c.x,x=c.y,_=i.x,w=i.y;s.startMove(g,(function(e){m[4]=b+e.x,m[5]=v+e.y,c.x=F-e.xWithoutScale,c.y=x-e.yWithoutScale,i.x=_-e.xWithoutScale,i.y=w-e.yWithoutScale,u.setAttribute("transform","matrix("+m.toString()+")")}))}else{if(s.stopMove(
),
...
l=null,o=null,s.config.enableDragDrop)for(;null!=r&&r!=d;){if(r.hasAttribute&&r.hasAttribute(FamilyTree.attr.node_id)){var k=r.getAttribute(FamilyTree.attr.node_id);if(s._gragStartedId&&k!=s._gragStartedId){l=k,o=r;break}}r=r.parentNode}if("draging"==l&&(l=null,o=null
),
null!=l){o.classList.add("bft-drag-over");for(var S=s.getNode(l
),
C=FamilyTree.getStParentNodes(S
),
I=0;I<C.length;I++){var A=s.getNodeElement(C[I].id);A&&(A.style.opacity=.1)}!s.canUpdateLink(n.id,l)&&d.classList?(d.classList.remove("bft-cursor-grab"
),
d.classList.remove("bft-cursor-move"
),
d.classList.remove("bft-cursor-copy"
...
d.classList.remove("bft-cursor-nodrop"))}var N=(i.x-c.x)/f,M=(i.y-c.y)/f;if(m[4]=p+N,m[5]=h+M,!e._dragEventFired&&(Math.abs(i.x-c.x)>FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE||Math.abs(i.y-c.y)>FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE))!1===FamilyTree.events.publish("drag",[s,k,t])&&T(
),
e._dragEventFired=!0;u.setAttribute("transform","matrix("+m.toString()+")")}}},T=function(t){if(s.stopMove(
),
...
n.id==l||null==l)return e._dragEventFired&&FamilyTree.events.publish("drop",[s,n.id,void 0,u]
),
d.removeChild(u
),
void(s._gragStartedId=null);var r=s.getNode(l);if(!1===FamilyTree.events.publish("drop",[s,n.id,r.id,u]))return y(l,o
),
d.removeChild(u
),
void(s._gragStartedId=null);if(s.canUpdateLink(n.id,l)){var a=s.get(n.id);a.pid=l,a.stpid=null,s.updateNode(a,null,!0)}else d.removeChild(u
),
y(l,o);s._gragStartedId=null};d.addEventListener(i.move,g
),
d.addEventListener(i.up,T
),
i.leave&&d.addEventListener(i.leave,T)}},FamilyTree.prototype._resizeHandler=function(e,t){if(this.isVisible){var i=this.getViewBox(
),
r=this.getSvg(
),
...
l=a/i[2],o=n/i[3],s=l>o?o:l;r.setAttribute("width",this.width()
),
r.setAttribute("height",this.height()
),
i[2]=this.width()/s,i[3]=this.height()/s,this.setViewBox(i
),
this.xScrollUI.create(this.width()
),
this.yScrollUI.create(this.height()
),
this._draw(!1,FamilyTree.action.resize)}},FamilyTree.prototype._nodeDbClickHandler=function(e,t){if(!1===FamilyTree.events.publish("dbclick",[this,this.get(e)]))return!1;this._commonClickHandler(e,t,this.config.nodeMouseDbClick)},FamilyTree.prototype._nodeClickHandler=function(e,t){var i=this.getNodeElement(e);if(i&&i._dragEventFired)i._dragEventFired=!1;else{if(!1===FamilyTree.events.publish("click",[this,{node:this.getNode(e
),
event:t}]))return!1;this._commonClickHandler(e,t,this.config.nodeMouseClick)}},FamilyTree.prototype._nodeCircleMenuItemClickHandler=function(e,t){var i=e.parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id
),
r=e.getAttribute(FamilyTree.attr.control_node_circle_menu_name
),
a=this.nodeCircleMenuUI._menu[r];FamilyTree.events.publish("click",[this.nodeCircleMenuUI,{nodeId:i,menuItemName:r,menuItem:a,event:t}])},FamilyTree.prototype._nodeCircleMenuClickHandler=function(e){FamilyTree.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE&&this.searchUI.hide(
),
this.nodeMenuUI.hide(
),
this.nodeContextMenuUI.hide(
),
this.menuUI.hide();var t=this.getNode(e
),
i=null;if(Array.isArray(t.tags))for(var r=0;r<t.tags.length;r++){var a=t.tags[r];this.config.tags[a]&&this.config.tags[a].nodeCircleMenu&&(i=this.config.tags[a].nodeCircleMenu)}this.nodeCircleMenuUI.show(e,i)},FamilyTree.prototype._commonClickHandler=function(e,t,i){var r;(FamilyTree.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE&&this.searchUI.hide(
),
this.nodeMenuUI.hide(
),
this.nodeContextMenuUI.hide(
...
this.ripple(r.id,t.clientX,t.clientY)));i==FamilyTree.action.details&&((r=this.getNode(e))&&(this.editUI.show(r.id,!0
),
this.ripple(r.id,t.clientX,t.clientY)))},FamilyTree.prototype._menuHandlerMouseDownHandler=function(e,t){t.stopPropagation(
),
t.preventDefault()},FamilyTree.prototype._nodeMenuClickHandler=function(e,t,i){FamilyTree.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE&&this.searchUI.hide(
),
this.nodeMenuUI.hide(
),
this.nodeContextMenuUI.hide(
...
this.nodeCircleMenuUI.hide();var r=this.getNode(e
),
a=null;if(Array.isArray(r.tags))for(var n=0;n<r.tags.length;n++){var l=r.tags[n];this.config.tags[l]&&this.config.tags[l].nodeMenu&&(a=this.config.tags[l].nodeMenu)}this.nodeMenuUI.showStickIn(t,e,null,a)},FamilyTree.prototype._menuClickHandler=function(e,t){t.stopPropagation(
),
t.preventDefault(
),
this.nodeMenuUI.hide(
...
this.menuUI.show(e.offsetLeft,e.offsetTop)},FamilyTree.prototype._lonelyButtonHandler=function(){var e={id:this.generateId()};!1!==this.addNode(e,null,!0)&&this.center(e.id)},FamilyTree.prototype.toggleExpandCollapse=function(e,t){var i=this.getNode(e
),
r=this.getCollapsedIds(i);if(r.length){if(!1===FamilyTree.events.publish("expcollclick",[this,!1,e,r]))return!1;this.expand(e,r,!1)}else{if(!1===FamilyTree.events.publish("expcollclick",[this,!0,e,i.childrenIds]))return!1;this.collapse(e,i.childrenIds,!1)}t&&this.ripple(i.id,t.clientX,t.clientY)},FamilyTree.prototype._move=function(e,t,i){i[0]=t,i[1]=e,this.setViewBox(i
),
this.xScrollUI.setPosition(
),
this.yScrollUI.setPosition()},FamilyTree.prototype.startMove=function(e,t){if(e){if(this._movePosition=e,!this._moveInterval){var i=this,r=this.getViewBox().slice(0
),
a=this.getScale(
),
n=0,l=0;this._moveInterval=setInterval((function(){var e={x:0,y:0,xWithoutScale:0,yWithoutScale:0};i._movePosition.left&&(n++,e.x=n*FamilyTree.MOVE_STEP/a,e.xWithoutScale=n*FamilyTree.MOVE_STEP
),
...
FamilyTree.MOVE_INTERVAL)}}else console.error("movePosition parameter not defined")},FamilyTree.prototype.stopMove=function(){this._moveInterval&&(clearInterval(this._moveInterval
),
this._moveInterval=null,this._movePosition=null)},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree.node=function(e,t,i,r){this.templateName=r,this.id=e,this.pid=t,this.children=[],this.childrenIds=[],this.parent=null,this.stpid=null,this.stParent=null,this.stChildren=[],this.stChildrenIds=[],this.tags=i,this.tags||(this.tags=[])},FamilyTree.prototype._mouseDownHandler=function(e,t,i){var r=this;FamilyTree.HIDE_EDIT_FORM_ON_PAN&&this.editUI.hide(
),
FamilyTree.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE&&this.searchUI.hide(
),
this.nodeMenuUI.hide(
...
this.nodeCircleMenuUI.hide();var a=this.getViewBox(
),
n=this.getScale(
),
...
s={diffX:0,diffY:0,x0:l.x,y0:l.y,type:"pan",viewBoxLeft:a[0],viewBoxTop:a[1]};t.touches&&t.touches.length>1&&(s.type="pinch",s.dist=Math.sqrt((l.x-o.x)*(l.x-o.x)+(l.y-o.y)*(l.y-o.y))
),
"pan"==s.type&&(this._hideBeforeAnimation(
),
this._changeCursorOnPanStart(a,n,t));var d=function(e){var t=FamilyTree._getClientTouchesXY(e,0);if(s&&"pan"==s.type){r._hideBeforeAnimation(
),
s.diffX=t.x-s.x0,s.diffY=t.y-s.y0;var i=-s.diffY/n+s.viewBoxTop,l=-s.diffX/n+s.viewBoxLeft;r._move(i,l,a)}else if(s&&"pinch"==s.type){var o=FamilyTree._getClientTouchesXY(e,1
),
d=Math.sqrt((t.x-o.x)*(t.x-o.x)+(t.y-o.y)*(t.y-o.y)
),
c=1+(d-s.dist)/(s.dist/100)/100;s.dist=d;var m=FamilyTree._pinchMiddlePointInPercent(r.element,r.width(
),
r.height(
),
e);r.zoom(c,m)}},c=function(){"pan"==s.type&&r.config.sticky?setTimeout((function(){FamilyTree._moveToBoundaryArea(e,r.getViewBox(
),
r.response.boundary,(function(){r._draw(!0,FamilyTree.action.pan)}))}
),
0):"pan"!=s.type||r.config.sticky||setTimeout((function(){r._draw(!0,FamilyTree.action.pan)}
),
0
),
"pan"==s.type&&r._changeCursorOnPanEnd(
),
s=null,e.removeEventListener(i.move,d
),
e.removeEventListener(i.up,c
),
i.leave&&e.removeEventListener(i.leave,c
),
i.touchstart&&e.removeEventListener(i.touchstart,c)};this.config.enablePan&&(e.addEventListener(i.move,d
),
e.addEventListener(i.up,c
),
i.leave&&e.addEventListener(i.leave,c
),
i.touchstart&&e.addEventListener(i.touchstart,c))},FamilyTree.prototype._changeCursorOnPanStart=function(e,t,i){var r=this.getPointerElement(
),
a=FamilyTree._getOffsetXY(this.element,i
),
n=a.x/t+e[0]-16/t,l=a.y/t+e[1]-16/t;r.style.display="inherit",r.setAttribute("transform","matrix(0,0,0,0,"+n+","+l+")"
),
FamilyTree.animate(r,{transform:[0,0,0,0,n,l],opacity:0},{transform:[1/t,0,0,1/t,n,l],opacity:1},300,FamilyTree.anim.outBack)},FamilyTree.prototype._changeCursorOnPanEnd=function(){this.getPointerElement().style.display="none"},FamilyTree.searchUI=function(){this.lastSearch=[],this._searchAfterEnterPress=!1},FamilyTree.searchUI.prototype.init=function(e){this.obj=e,this._initSearchFields();var t=this,i=this.obj.config.padding-10,r=this.obj.config.padding-10,a=this.obj.getMenuButton();if(a){var n=a.getBoundingClientRect(
),
l=this.obj.getSvg().getBoundingClientRect();i=l.right-n.left+10,r=n.top-l.top-10}var o=document.createElement("div");o.classList.add("bft-search"
),
o.style.right=i+"px",o.style.top=r+"px";var s=FamilyTree.elements.textbox({},{label:FamilyTree.SEARCH_PLACEHOLDER,btn:"X"},"320px");o.innerHTML+=s.html,this.xBtn=o.querySelector("[data-input-btn]"
),
this.xBtn.style.display="none",this.searchTableWrapper=document.createElement("div"
),
o.appendChild(this.searchTableWrapper);var d=e.getSvg().nextSibling;this.obj.element.insertBefore(o,d
),
FamilyTree.input.init(o
),
this.input=document.getElementById(s.id
),
this.xBtn.addEventListener("click",(function(e){e.preventDefault(
),
t.hide()})
),
this.input.addEventListener("keypress",(function(e){"Enter"==e.key&&e.preventDefault()})
),
this.input.addEventListener("focus",(function(e){t.xBtn.style.display="",t._search()})
),
this.input.addEventListener("blur",(function(e){FamilyTree.isNEU(t.input.value)&&FamilyTree.SEARCH_HELP_SYMBOL!=t.input.value&&(t.xBtn.style.display="none")})
),
this.input.addEventListener("keydown",(function(e){("ArrowDown"==e.key||"ArrowUp"==e.key)&&e.preventDefault()})
),
this.input.addEventListener("keyup",(function(e){"ArrowDown"==e.key?c():"ArrowUp"==e.key?m():"Enter"==e.key?t._enterHandler():"Escape"==e.key?t.hide():t._search()}));var c=function(){var e=t.obj.element.querySelectorAll("[data-search-item-id]"
),
i=t.obj.element.querySelector('[data-selected="yes"]');null==i&&e.length>0?e[0].setAttribute("data-selected","yes"):e.length>0&&i.nextSibling&&i.nextSibling.setAttribute&&(i.removeAttribute("data-selected"
),
i.nextSibling.setAttribute("data-selected","yes"))},m=function(){var e=t.obj.element.querySelectorAll("[data-search-item-id]"
),
i=t.obj.element.querySelector('[data-selected="yes"]');null==i&&e.length>0?e[e.length-1].setAttribute("data-selected","yes"):e.length>0&&i.previousSibling&&i.previousSibling.setAttribute&&(i.removeAttribute("data-selected"
),
i.previousSibling.setAttribute("data-selected","yes"))}},FamilyTree.searchUI.prototype._enterHandler=function(){var e=this.obj.element.querySelector('[data-selected="yes"]');if(e){if(e.hasAttribute("data-search-item-id")){var t=e.getAttribute("data-search-item-id");if(this.input.value!=FamilyTree.SEARCH_HELP_SYMBOL)0!=FamilyTree.events.publish("searchclick",[this.obj,t])&&this.obj.center(t);else this.input.value=t+" ",this.searchTableWrapper.innerHTML=""}}else this._searchAfterEnterPress=!0,this.__search(
),
this.searchTableWrapper.innerHTML="",this.obj.draw()},FamilyTree.searchUI.prototype._initSearchFields=function(){if(null==this.obj.config.searchFields){this._searchFields=[];for(var e=0;e<this.obj.response.allFields.length;e++){var t=this.obj.response.allFields[e];"tags"==t||FamilyTree._fieldIsImg(this.obj.config,t)||this._searchFields.push(t)}}else this._searchFields=this.obj.config.searchFields;if(null==this.obj.config.searchFieldsAbbreviation){this._searchFieldsAbbreviation={};for(e=0;e<this._searchFields.length;e++){for(var i=this._searchFields[e],r=0,a=i.slice(0,r+1).toLowerCase();this._searchFieldsAbbreviation[a];)r++,a=i.slice(0,r+1).toLowerCase();this._searchFieldsAbbreviation[a]=i}}else this._searchFieldsAbbreviation=this.obj.config.searchFieldsAbbreviation},FamilyTree.searchUI.prototype.find=function(e){this.input&&(this.input.value=e,document.activeElement==this.input?this._search(e):this.input.focus())},FamilyTree.searchUI.prototype.addMatchTag=function(e){if(this._searchAfterEnterPress){for(var t=0;t<this.lastSearch.length;t++)if(this.lastSearch[t].id==e)return!0;return!1}return null},FamilyTree.searchUI.prototype.__search=function(){this.lastSearch=FamilyTree._search.search(this.obj.config.nodes,this.input.value,this._searchFields,this._searchFields,this.obj.config.searchDisplayField,this.obj.config.searchFieldsWeight,this._searchFieldsAbbreviation)},FamilyTree.searchUI.prototype._search=function(){var e,t=this;if(this._searchAfterEnterPress=!1,this.input.value==FamilyTree.SEARCH_HELP_SYMBOL)e=this.helpView();else{this.__search();var i=FamilyTree._getFistImgField(this.obj.config);e=`<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${function(){for(var e="",r=0;r<t.lastSearch.length&&!(r>=FamilyTree.SEARCH_RESULT_LIMIT);r++){var a=t.lastSearch[r],n="";if(i){var l=t.obj._get(a.id);"function"==typeof i?n=i(t.obj,t.obj.getNode(a.id
),
l):l[i]&&(n=l[i])}var o="",s="";t.obj.config.searchDisplayField==a.__searchField?o=a.__searchMarks:t.obj.config.searchDisplayField?(o=a[t.obj.config.searchDisplayField],FamilyTree.isNEU(o)&&(o=""
),
s=a.__searchMarks):o=a.__searchMarks,e+=FamilyTree.searchUI.createItem(n,a.id,o,s)}return e}()}  \n                        </tbody>\n                    </table>`}this.searchTableWrapper.innerHTML=e;for(var r=this.obj.element.querySelectorAll("[data-search-item-id]"
),
a=0;a<r.length;a++)r[a].addEventListener("click",(function(){if(this.hasAttribute("data-search-item-id")){var e=this.getAttribute("data-search-item-id");if(t.input.value!=FamilyTree.SEARCH_HELP_SYMBOL){if(!1!==FamilyTree.events.publish("searchclick",[t.obj,e])){t.obj.center(this.getAttribute("data-search-item-id"));var i=t.obj.element.querySelector('[data-selected="yes"]');i&&i.removeAttribute("data-selected"
),
this.setAttribute("data-selected","yes"
),
t.input.focus()}}else t.input.value=e+" ",t.searchTableWrapper.innerHTML="",t.input.focus()}}))},FamilyTree.searchUI.prototype.helpView=function(){var e='<table border="0" cellspacing="0" cellpadding="0">';for(var t in this._searchFieldsAbbreviation)e+=`<tr data-search-item-id="${t}" style="height: 50px;"><td class="bft-search-image-td" style="text-align: center;">${t}</td><td class="bft-search-text-td">${this._searchFieldsAbbreviation[t]}</td></tr>`;return e+="</table>"},FamilyTree.searchUI.createItem=function(e,t,i,r){return i&&(i="<b>"+i+"</b>"
),
`<tr data-search-item-id="${t}">\n                <td class="bft-search-image-td">\n                    ${e=e?`<div class="bft-search-photo" style="background-image: url(${e})"></div>`:`<div class="bft-search-photo">${FamilyTree.icon.user(32,32,"#aeaeae")}</div>`}\n                </td>\n                <td class="bft-search-text-td">${i} <br/>${r}</td>\n            </tr>`},FamilyTree.searchUI.prototype.hide=function(){this._searchAfterEnterPress&&(this._searchAfterEnterPress=!1,this.obj.draw()
),
this.lastSearch=[],this.xBtn&&(this.xBtn.style.display="none"
),
this.searchTableWrapper&&(this.searchTableWrapper.innerHTML=""
),
this.input&&(this.input.value="",document.activeElement==this.input&&this.input.blur(
),
document.activeElement==this.xBtn&&FamilyTree.input.blurHandler(this.input))},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree.manager=function(e){this.config=e.config,this.layoutConfigs=e._layoutConfigs,this.visibleNodeIds=[],this.viewBox=null,this.action=null,this.actionParams=null,this.nodes={},this.oldNodes={},this.maxX=null,this.maxY=null,this.minX=null,this.minY=null,this.bordersByRootIdAndLevel=null,this.roots=null,this.state=null,this.vbIsInitializedFromState=!1,this.rootList=[],this.instance=e},FamilyTree.manager.prototype.read=function(e,t,i,r,a,n,l,o){var s=this;FamilyTree.state._get(this.config.state,t,i,(function(d){s.state=d,s.action=a,s.actionParams=n,a!=FamilyTree.action.init||!s.state||n&&n.method&&"fit"==n.method?(s.viewBox=r,s.vbIsInitializedFromState=!1):(s.viewBox=s.state.vb,s.vbIsInitializedFromState=!0,Array.isArray(s.state.roots)&&(s.config.roots=s.state.roots));var c=s.maxX,m=s.maxY,p=s.minX,h=s.minY,f=s.bordersByRootIdAndLevel,u=s.roots,y=s.nodes;if(e){var g=FamilyTree.manager._getResponse(t,i,s.visibleNodeIds,s.config,c,m,p,h,s.viewBox,u,s.action,s.actionParams,y,s.oldNodes,s.vbIsInitializedFromState);a!=FamilyTree.action.exporting&&(s.maxX=c,s.maxY=m,s.minX=p,s.minY=h,s.roots=u,s.nodes=y,s.visibleNodeIds=g.visibleNodeIds
),
g.bordersByRootIdAndLevel=f,g.roots=u,g.adjustify={x:0,y:0},s.state&&(g.adjustify=s.state.adjustify
),
l(g)}else s.oldNodes=y||null,s._read((function(e){c=e.maxX,m=e.maxY,p=e.minX,h=e.minY,f=e.bordersByRootIdAndLevel,u=e.roots,y=e.nodes;var r=FamilyTree.manager._getResponse(t,i,s.visibleNodeIds,s.config,c,m,p,h,s.viewBox,u,s.action,s.actionParams,y,s.oldNodes,s.vbIsInitializedFromState);r.notif=e.limit,r.roots=u,r.bordersByRootIdAndLevel=f,r.adjustify=e.adjustify,a!=FamilyTree.action.exporting&&(s.maxX=c,s.maxY=m,s.minX=p,s.minY=h,s.roots=u,s.nodes=y,s.visibleNodeIds=r.visibleNodeIds,s.bordersByRootIdAndLevel=f,s.rootList=e.rootList
),
l(r)}
),
o)}))},FamilyTree.manager.prototype._read=function(e,t){var i=this,r=FamilyTree.manager._createNodes(this.instance);t(r);var a=r.nodes,n=r.roots,l=FamilyTree.remote;null==l&&(l=FamilyTree.local
),
l._setPositions(n,i.layoutConfigs,(function(t){var l=FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny(n,a,i.action,i.actionParams,i.oldNodes,i.config.orientation);i.state&&i.action==FamilyTree.action.init&&(l=i.state.adjustify);for(var o={minX:null,minY:null,maxX:null,maxY:null},s={},d=0;d<n.length;d++)FamilyTree.manager._setMinMaxXYAdjustifyIterate(n[d],n[d],o,0,s,l,i.config.orientation);e({minX:o.minX,minY:o.minY,maxX:o.maxX,maxY:o.maxY,bordersByRootIdAndLevel:s,nodes:a,roots:n,rootList:r.rootList,limit:t,adjustify:l})}
),
a)},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree.manager._initDinamicNode=function(e,t,i){t&&(e.lcn=t
),
i&&(e.isAssistant=!0);var r=FamilyTree.t(e.templateName);e.w=r&&r.size?r.size[0]:0,e.h=r&&r.size?r.size[1]:0,e.isSplit="split"==e.templateName},FamilyTree.manager._setCollpasedProperty=function(e,t,i,r,a,n,l){null==e.collapsed&&t.collapse&&t.collapse.allChildren?e.collapsed=!0:null==e.collapsed&&(e.collapsed=!1
),
...
a==FamilyTree.action.init&&null!=l?e.collapsed=!l.exp.has(e.id):a==FamilyTree.action.init?e.collapsed=t.collapse&&n>=t.collapse.level-1&&-1==r.indexOf(e.id):a==FamilyTree.action.centerNode||a==FamilyTree.action.insert||a==FamilyTree.action.expand||a==FamilyTree.action.collapse?r.has(e.id)&&(e.collapsed=!1):a==FamilyTree.action.update&&i&&i.changeRoots&&i.changeRoots.has(e.id)&&(e.collapsed=!1)},FamilyTree.manager._initNode=function(e,t,i,r,a,n,l){var o=l.manager.config,s=l.manager.layoutConfigs,d=l.manager.action,c=l.manager.actionParams,m=l.manager.state,p=s[i||"base"];null==e.parent&&FamilyTree.manager._setCollpasedProperty(e,p,c,a,d,r-1,m);for(var h=0;h<e.childrenIds.length;h++){var f=t[e.childrenIds[h]];if(FamilyTree.manager._setCollpasedProperty(f,p,c,a,d,r,m
),
!f.collapsed){if(f.parent=e,null!=f.ppid){var u=t[f.ppid];u&&(f.parentPartner=u)}(-1!=f.tags.indexOf("left-partner")||-1!=f.tags.indexOf("right-partner")||-1!=f.tags.indexOf("partner")||f.parentPartner)&&-1==n.indexOf(e.id)&&n.push(e.id
),
e.children.push(f)}}if(d!=FamilyTree.action.minimize||e.min?d==FamilyTree.action.maximize&&!0===e.min?(c.all||c.id==e.id)&&(e.min=!1):d==FamilyTree.action.exporting&&!1===c.min?e.min=!1:d==FamilyTree.action.init&&null!=m&&(e.min=m.min.has(e.id)):(c.all||c.id==e.id)&&(e.min=!0
),
!e.min)for(h=0;h<e.stChildrenIds.length;h++){f=t[e.stChildrenIds[h]];e.tags&&e.tags.has("filter")||(f.stParent=e,e.stChildren.push(f))}null!=r&&(e.level=r
),
i&&(e.lcn=i);var y=FamilyTree._getSubLevels(e.tags,o.tags);y>0&&(e.subLevels=y
),
-1!=e.tags.indexOf("assistant")&&null!=e.parent&&(e.isAssistant=!0);var g=FamilyTree.t(e.templateName,e.min);e.w=g&&g.size?g.size[0]:0,e.h=g&&g.size?g.size[1]:0,e.padding=g&&g.padding?g.padding:[0,0,0,0];var T={node:e};FamilyTree.events.publish("node-initialized",[l,T]
),
FamilyTree.events.publish("node-created",[e])},FamilyTree.manager._iterate=function(e,t,i,r,a,n,l,o,s,d,c,m){var p=m.manager.layoutConfigs;if(FamilyTree.manager._initNode(t,i,s,r,d,c,m
),
...
i.orderBy.desc?n.localeCompare(a):a.localeCompare(n)):void 0}));for(c=0;c<s.length;c++){var y=s[c],g=(u=e[y],n?n[y]:null
),
T=e[u.stpid],b=e[u.pid];if(T||(u.stpid=null
),
b||(u.pid=null
),
T){var v=n?n[T.id]:null;v&&(T.min=v.min
),
T.stChildrenIds.push(u.id)}else b?(g&&(u.collapsed=g.collapsed,u.min=g.min
),
b.childrenIds.push(u.id)):(g&&(u.collapsed=g.collapsed,u.min=g.min
),
t.push(u
),
l.push(u.id));r==FamilyTree.action.init&&(u.min=FamilyTree._getMin(u,i))}},FamilyTree.manager._createNodes=function(e){var t=e.manager.config,i=e.manager.layoutConfigs,r=e.manager.action,a=e.manager.actionParams,n=e.manager.oldNodes,l=e.manager.state,o={},s=[],d=[];if(FamilyTree.manager.__createNodes(o,s,t,r,a,n,d,e
),
null!=t.roots){s=[];for(var c=0;c<t.roots.length;c++){var m=o[t.roots[c]];if(m&&r==FamilyTree.action.centerNode){for(var p=m;null!=p.pid||null!=p.stpid;)p=null==p.pid&&null!=p.stpid?o[p.stpid]:o[p.pid];for(var h=o[a.id];(null!=h.pid||null!=h.stpid)&&h!=m;)h=null==h.pid&&null!=h.stpid?o[h.stpid]:o[h.pid];p==h&&(m=p)}if(m){for(var f=!1,u=0;u<s.length;u++)if(s[u].id==m.id){f=!0;break}if(!f){if(!FamilyTree.isNEU(m.pid))(H=(b=o[m.pid]).childrenIds.indexOf(m.id))>-1&&b.childrenIds.splice(H,1);s.push(m)}}}t.roots=[];for(c=0;c<s.length;c++)t.roots.push(s[c].id)}r==FamilyTree.action.exporting&&null!=a.id&&((g=o[a.id])&&(g.pid=null,s=[g]));var y=[];if(r==FamilyTree.action.init&&t.expand&&t.expand.nodes&&null==l)for(c=0;c<t.expand.nodes.length;c++){var g=o[t.expand.nodes[c]];for(!0===t.expand.allChildren&&FamilyTree.manager._addExpandedNodeIdsIterate(g,o,y);g;)y.push(g.id
),
null==g.pid&&null!=g.stpid?(g=o[g.stpid]).min=!1:g=o[g.pid]}else if(r==FamilyTree.action.expand&&a.ids&&"all"!=a.ids||r==FamilyTree.action.collapse&&a&&a.expandIds){var T;T=r==FamilyTree.action.expand?a.ids:a.expandIds;for(c=0;c<T.length;c++)for(var b=o[(g=o[T[c]]).pid];b;)y.push(b.id
),
null==b.pid&&null!=b.stpid?(b=o[b.stpid]).min=!1:b=o[b.pid]}else if(r==FamilyTree.action.centerNode){for(var v=o[a.id];v;){if(y.push(v.id
),
a.options.parentState===FamilyTree.COLLAPSE_PARENT_NEIGHBORS&&v)for(c=0;c<v.childrenIds.length;c++){(z=o[v.childrenIds[c]]).collapsed=!0}null==v.pid&&null!=v.stpid?(v=o[v.stpid]).min=!1:v=o[v.pid]}v=o[a.id];if(a.options.childrenState===FamilyTree.COLLAPSE_SUB_CHILDRENS)for(c=0;c<v.childrenIds.length;c++){(x=o[v.childrenIds[c]]).collapsed=!1;for(var F=0;F<x.childrenIds.length;F++){o[x.childrenIds[F]].collapsed=!0}}if(a.options.parentState===FamilyTree.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)if(b=o[v.pid])for(c=0;c<b.childrenIds.length;c++){var x;if((x=o[b.childrenIds[c]])!=v){x.collapsed=!1;for(F=0;F<x.childrenIds.length;F++){o[x.childrenIds[F]].collapsed=!0}}}}else if(r==FamilyTree.action.insert)for(g=o[a.insertedNodeId];g;)y.push(g.id
),
null==g.pid&&null!=g.stpid?(g=o[g.stpid]).min=!1:g=o[g.pid];var _=[],w={},k=[],S={},C=[];for(c=0;c<s.length;c++)FamilyTree.manager._iterate(s[c],s[c],o,0,_,w,k,S,"",y,C,e);if(r==FamilyTree.action.collapse&&a&&Array.isArray(a.expandIds)&&Array.isArray(a.collapseIds))for(c=0;c<a.ids.length;c++){if(a.expandIds.has(a.collapseIds[c]))console.error(`id ${a.collapseIds[c]} exist in both collapseIds and expandIds`);else(g=o[a.collapseIds[c]])&&(g.collapsed=!0)}for(c=s.length-1;c>=0;c--)s[c].collapsed&&s.splice(c,1);for(c=0;c<C.length;c++){g=o[C[c]];var I=[],A=[],N=[],M={},E=0,L=0,O=0,U=[],B=[];for(F=0;F<g.children.length;F++){(z=g.children[F]).isAssistant?I.push(z.id):-1!=z.tags.indexOf("right-partner")?(z.isPartner=1,z.children=[],A.push(z.id)):-1!=z.tags.indexOf("left-partner")?(z.isPartner=2,z.children=[],N.push(z.id)):-1==z.tags.indexOf("partner")||E%2?-1!=z.tags.indexOf("partner")&&E%2?(z.isPartner=2,z.children=[],N.push(z.id
),
E++):z.parentPartner?(M[z.parentPartner.id]||(M[z.parentPartner.id]=[]
),
M[z.parentPartner.id].push(z.id)):I.push(z.id):(z.isPartner=1,z.children=[],A.push(z.id
),
E++)}g.children=[];var P=[];for(F=0;F<A.length;F++){M[(z=o[A[F]]).id]?g.children.push(z):g.children.splice(0,0,z);for(var D=0;D<z.childrenIds.length;D++)P.push(z.childrenIds[D])}var R=[];for(F=0;F<N.length;F++){M[(z=o[N[F]]).id]?g.children.push(z):g.children.splice(0,0,z);for(D=0;D<z.childrenIds.length;D++)R.push(z.childrenIds[D])}for(F=0;F<R.length;F++){(z=o[R[F]]).collapsed||(z.parentPartner=z.parent,z.parent=g,z.isChildOfPartner=!0,g.children.push(z))}for(F=N.length-1;F>=0;F--)if(M[N[F]])for(u=0;u<M[N[F]].length;u++)g.children.push(o[M[N[F]][u]]
),
L++,-1==B.indexOf(N[F])&&B.push(N[F]);for(F=0;F<I.length;F++){var z=o[I[F]];g.children.push(z)}for(F=0;F<A.length;F++)if(M[A[F]])for(u=0;u<M[A[F]].length;u++)g.children.push(o[M[A[F]][u]]
),
O++,-1==U.indexOf(A[F])&&U.push(A[F]);for(F=0;F<P.length;F++){(z=o[P[F]]).collapsed||(z.parentPartner=z.parent,z.parent=g,z.isChildOfPartner=!0,g.children.push(z))}g.partnerSeparation=Math.max(B.length,U.length)*t.partnerChildrenSplitSeparation+t.minPartnerSeparation,I.length||!L||O?I.length||L||!O?I.length||1!=L||1!=O?I.length||L||O?!I.length||L||O?I.length&&(L||O)?g.hasPartners=7:g.hasPartners=1:g.hasPartners=6:g.hasPartners=5:g.hasPartners=4:g.hasPartners=3:g.hasPartners=2}for(c=0;c<k.length;c++){if((ae=i[(g=o[k[c]]).lcn?g.lcn:"base"]).layout==FamilyTree.normal||!S[g.pid])for(F=0;F<g.subLevels;F++){var H,j=new FamilyTree.node(g.id+"_sub_level_index_"+F,g.pid,[],"subLevel");if(FamilyTree.manager._initDinamicNode(j,g.lcn
),
b=g.parent)(H=b.children.indexOf(g))>-1&&(b.children.splice(H,1
),
b.children.splice(H,0,j)
),
j.children.push(g
),
j.parent=b,g.parent=j,o[j.id]=j}}for(var $ in w){(b=o[$]).hasAssistants=!0;j=new FamilyTree.node(b.id+"_split_assitant_0",b.id,["assistant"],"split");FamilyTree.manager._initDinamicNode(j,b.lcn,!0
),
o[j.id]=j;var Y=[];for(F=b.children.length-1;F>=0;F--){(z=b.children[F]).isAssistant?(z.parent=null,b.children.splice(F,1
),
Y.splice(0,0,z.id)):z.isPartner||(z.parent&&S[z.parent.id]&&j&&z.parent.id!=j.id&&(Object.defineProperty(S,j.id,Object.getOwnPropertyDescriptor(S,z.parent.id)
),
delete S[z.parent.id]
),
z.parent=j,j.children.unshift(z
),
b.children.splice(F,1))}if(Y.length%2){var q=o[Y[Y.length-1]],X=new FamilyTree.node(q.id+"_mirror",b.pid,[],"mirror");FamilyTree.manager._initDinamicNode(X,q.lcn,!0
),
q._m=X.id,X.isAssistant=!0,X.w=q.w,X.h=q.h,o[X.id]=X,Y.splice(Y.length-1,0,X.id)}var V=1;for(F=Y.length-1;F>=0;F--)if(F%2&&F!=Y.length-1){var W=new FamilyTree.node(b.id+"_split_assitant_"+V,b.pid,[],"split");FamilyTree.manager._initDinamicNode(W,b.lcn,!0
),
o[W.id]=W,Y.splice(F,0,W.id
),
V++}else F%2&&Y.splice(F,0,j.id);for(F=0;F<Y.length;F+=3){var G=null;G=0==F?b:o[Y[F-2]];var J=o[Y[F]],K=o[Y[F+1]],Z=o[Y[F+2]];J.parent=G,K.parent=G,Z.parent=G,G.children.push(J
),
G.children.push(K
),
G.children.push(Z)}}var Q=!1;for(var ee in i){if((ae=i[ee]).layout==FamilyTree.mixed||ae.layout==FamilyTree.tree||ae.layout==FamilyTree.treeRightOffset||ae.layout==FamilyTree.treeLeftOffset){Q=!0;break}}var te=FamilyTree.events.has("node-layout",e._event_id);if(Q||te){var ie={nodes:o,config:t,action:r,actionParams:a};for(var $ in S){for(var re=b=o[$];re.isSplit;)re=o[re.pid];var ae;if((ae=i[b.lcn?b.lcn:"base"]).layout==FamilyTree.mixed||ae.layout==FamilyTree.tree||ae.layout==FamilyTree.treeRightOffset||ae.layout==FamilyTree.treeLeftOffset||te)if(ie.pnode=b,ie.layout=ae.layout,ie.childrenIds=S[$],ie.lastChildrenPidIds=S,FamilyTree.events.publish("node-layout",[e,ie]
),
FamilyTree.events.publish("layout",[ie]
),
ie.layout==FamilyTree.mixed){var ne=ie.childrenIds;for(c=ne.length-1;c>=0;c--){b=(z=o[ne[c]]).parent,z.layout=FamilyTree.mixed;for(F=b.children.length-1;F>=0;F--)if(z.id==b.children[F].id){b.children.splice(F,1);break}if(c>0){var le=o[ne[c-1]];z.parent=le,z.layout=FamilyTree.mixed,le.children.push(z)}else b.children.push(z)}}else if(ie.layout==FamilyTree.tree||ie.layout==FamilyTree.treeRightOffset||ie.layout==FamilyTree.treeLeftOffset){j=new FamilyTree.node(b.id+"_split_0",re.id,[],"split");FamilyTree.manager._initDinamicNode(j,b.lcn
),
o[j.id]=j,j.layout=FamilyTree.tree;var oe=[];for(c=ie.childrenIds.length-1;c>=0;c--){for(z=o[ie.childrenIds[c]],F=0;F<b.children.length;F++)b.children[F].id==z.id&&b.children.splice(F,1);if(z.parent=null,z.layout=FamilyTree.tree,ie.layout==FamilyTree.treeRightOffset&&oe.splice(0,0,z.id
),
ie.layout==FamilyTree.treeLeftOffset||ie.layout==FamilyTree.treeRightOffset){var se=new FamilyTree.node(z.id+"_mirror",re.id,[],"mirror");FamilyTree.manager._initDinamicNode(se,z.lcn
),
se.layout=FamilyTree.tree,o[se.id]=se,oe.splice(0,0,se.id)}ie.layout!=FamilyTree.treeRightOffset&&oe.splice(0,0,z.id)}for(V=1,F=oe.length-1;F>=0;F--)if(F%2&&F!=oe.length-1){W=new FamilyTree.node(b.id+"_split_"+V,re.id,[],"split");FamilyTree.manager._initDinamicNode(W,b.lcn
),
W.layout=FamilyTree.tree,o[W.id]=W,oe.splice(F,0,W.id
),
V++}else F%2&&oe.splice(F,0,j.id);for(F=0;F<oe.length;F+=3){G=null;0==F&&(G=b);J=o[oe[F]],K=o[oe[F+1]],Z=o[oe[F+2]];0!=F&&(G=o[oe[F-3]]
),
0==F||K||(G=o[oe[F-2]]
),
J.parent=G,G.children.push(J
),
K&&(0!=F&&(G=o[oe[F-2]]
),
K.parent=G,G.children.push(K)
),
Z&&(0!=F&&(G=o[oe[F-1]]
),
Z.parent=G,G.children.push(Z))}}}}if(FamilyTree.VERTICAL_CHILDREN_ASSISTANT)for(c=0;c<s.length;c++)FamilyTree.manager._verticalAssistantIterate(s[c],o);ie={nodes:o,roots:s};return FamilyTree.events.publish("nodes-initialized",[e,ie]
),
{nodes:ie.nodes,roots:ie.roots,rootList:d}},FamilyTree.manager._getOrderFieldValue=function(e,t){var i=t;return t.field&&(i=t.field
),
e[i]},FamilyTree.manager._getNodeWidth=function(e,t){switch(t.orientation){case FamilyTree.orientation.top:case FamilyTree.orientation.top_left:case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:return e.w;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:return e.h}return 0},FamilyTree.manager._isVisible=function(e,t,i,r){if(null!=e.x&&null!=e.y){if(t.lazyLoading&&r!==FamilyTree.action.exporting){function a(e,t){var i=e.x,r=e.y,a=e.w,n=e.h,l=t[0]-FamilyTree.LAZY_LOADING_FACTOR,o=t[2]+FamilyTree.LAZY_LOADING_FACTOR+t[0],s=t[1]-FamilyTree.LAZY_LOADING_FACTOR,d=t[3]+FamilyTree.LAZY_LOADING_FACTOR+t[1],c=i+a>l&&o>i;return c&&(c=r+n>s&&d>r
),
c}if(a(e,i))return!0;for(var n=0;n<e.children.length;n++)if(a(e.children[n],i))return!0;return!1}return!0}},FamilyTree.manager.getAllFields=function(e){var t=[FamilyTree.TAGS];for(var i in e.nodeBinding)t.push(e.nodeBinding[i]);for(i=0;i<e.nodes.length;i++)for(var r in e.nodes[i])r!==FamilyTree.ID&&r!==FamilyTree.TAGS&&r!==FamilyTree.NODES&&r!==FamilyTree.PID&&r!==FamilyTree.STPID&&(e.nodeBinding[r]||t.has(r)||t.push(r));return t},FamilyTree.manager._getMostDeepChild=function(e){if(e){var t=e;return function e(i){i.sl>t.sl&&(t=i);for(var r=0;r<i.children.length;r++)e(i.children[r])}(e
),
t}},FamilyTree.manager._getResponse=function(e,t,i,r,a,n,l,o,s,d,c,m,p,h,f){var u=d[0],y=[],g={top:null,left:null,bottom:null,right:null,minX:null,maxX:null,minY:null,maxY:null},T=[[],[],[]],b=a-l+2*r.padding,v=n-o+2*r.padding,F=FamilyTree.getScale(s,e,t,r.scaleInitial,r.scaleMax,r.scaleMin,b,v);if(g.top=o-r.padding,g.left=l-r.padding,g.bottom=n+r.padding-t/F,g.right=a+r.padding-e/F,g.maxX=a,g.minX=l,g.maxY=n,g.minY=o,0==d.length||null==s&&!f&&r.align==FamilyTree.CENTER){var x=Math.ceil(e/F
),
_=Math.ceil(t/F
),
w=0,k=0;if(x-2*r.padding>=a-l)switch(w=(a+l)/2-x/2,r.orientation){case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:w=(l-a)/2-x/2}else switch(w=u.x-x/2+FamilyTree.manager._getNodeWidth(u,r)/2,r.orientation){case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:(w=-(x/2-(l-a)/2))<r.padding-x&&(w=r.padding-x);break;case FamilyTree.orientation.left:case FamilyTree.orientation.bottom_left:case FamilyTree.orientation.top_left:case FamilyTree.orientation.left_top:(w=-(x/2-(a-l)/2))>-r.padding&&(w=-r.padding)}if(_-2*r.padding>=n-o)switch(k=(n+o)/2-_/2,r.orientation){case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:k=(o-n)/2-_/2}else switch((k=-(_/2-(n-o)/2))>-r.padding&&(k=-r.padding
),
r.orientation){case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:(k=-(_/2-(o-n)/2))<r.padding-_&&(k=r.padding-_);break;case FamilyTree.orientation.left:case FamilyTree.orientation.right:k=u.y-_/2+FamilyTree.manager._getNodeWidth(u,r)/2}s=[w,k,x,_]}else if(null==s&&!f&&r.align==FamilyTree.ORIENTATION){x=Math.ceil(e/F
),
_=Math.ceil(t/F
),
w=0,k=0;switch(r.orientation){case FamilyTree.orientation.top:w=u.x-x/2+FamilyTree.manager._getNodeWidth(u,r)/2,k=-r.padding;break;case FamilyTree.orientation.bottom:w=u.x-x/2+FamilyTree.manager._getNodeWidth(u,r)/2,k=r.padding-_;break;case FamilyTree.orientation.left:w=-r.padding,k=u.y-_/2+FamilyTree.manager._getNodeWidth(u,r)/2;break;case FamilyTree.orientation.right:w=r.padding-x,k=u.y-_/2+FamilyTree.manager._getNodeWidth(u,r)/2;break;case FamilyTree.orientation.top_left:w=-r.padding,k=-r.padding;break;case FamilyTree.orientation.right_top:w=r.padding-x,k=-r.padding;break;case FamilyTree.orientation.left_top:w=-r.padding,k=-r.padding;break;case FamilyTree.orientation.bottom_left:w=-r.padding,k=r.padding-_}s=[w,k,x,_],r.sticky&&(s[0]<g.left&&s[0]<g.right&&(s[0]=g.left>g.right?g.right:g.left
),
s[0]>g.right&&s[0]>g.left&&(s[0]=g.left>g.right?g.left:g.right
),
s[1]<g.top&&s[1]<g.bottom&&(s[1]=g.top>g.bottom?g.bottom:g.top
),
s[1]>g.bottom&&s[1]>g.top&&(s[1]=g.top>g.bottom?g.top:g.bottom))}if(c==FamilyTree.action.centerNode||c==FamilyTree.action.maximize){var S=p[m.id];1==m.options.horizontal&&(s[0]=S.x+S.w/2-s[2]/2
),
...
t[l].tags.push("group-dotted-lines-"+n);break}for(l=0;l<t.length;l++)if(t[l].id==a.from){if((c=JSON.parse(JSON.stringify(t[l]))).id=`balkan_group_dotted_${a.rootId}_balkan_id_${t[l].id}`,c.pid=`balkan_group_dotted_${a.rootId}_balkan_id_${a.to}`,c.tags){var o=c.tags.indexOf("group-dotted-lines");-1!=o&&c.tags.splice(o,1)}if(c.tags||(c.tags=[]
),
c.tags.push("bft-dotted-connector"
),
a.tags)for(var s=0;s<a.tags.length;s++)c.tags.push(a.tags[s]);t.push(c);break}}if(e.dottedLines.length)for(r=0;r<e.dottedLines.length;r++){var d=e.dottedLines[r];null==d.rootId&&(d.rootId=d.to);for(l=0;l<t.length;l++)if(t[l].id==d.from){var c;if((c=JSON.parse(JSON.stringify(t[l]))).id=`balkan_dotted_${d.rootId}_balkan_id_${t[l].id}`,d.rootId==d.to?c.pid=d.to:c.pid=`balkan_dotted_${d.rootId}_balkan_id_${d.to}`,c.tags||(c.tags=[]
),
c.tags.push("bft-dotted-connector"
),
d.tags)for(s=0;s<d.tags.length;s++)c.tags.push(d.tags[s]);t.push(c);break}}return t},FamilyTree.manager.__createNodes=function(e,t,i,r,a,n,l,o){for(var s=i.nodes,d=[],c={},m={},p=0;p<s.length;p++){var h,f=s[p];h=FamilyTree.STRING_TAGS?f.tags?f.tags.split(","):[]:Array.isArray(f.tags)?f.tags.slice(0):[],o.filterUI.addFilterTag(f)&&h.push("filter");var u=o.searchUI.addMatchTag(f.id);!0===u?h.unshift("match"):!1===u&&h.unshift("no-match"
),
f.gender&&h.push(f.gender);var y=FamilyTree._getTemplate(h,i.tags,i.template);f.templateName&&(y=f.templateName);var g=new FamilyTree.node(f.id,f.pid,h,y);g.ftChildrenIds=[],g.rids=[],FamilyTree.isNEU(f.ppid)||(g.ppid=f.ppid
),
...
Array.isArray(f.pids)?g.pids=f.pids:g.pids=[],null!=i.orderBy&&(g.order=FamilyTree.manager._getOrderFieldValue(f,i.orderBy)
),
e[f.id]=g,FamilyTree.isNEU(g.stpid)?(FamilyTree.isNEU(g.mid)||(c[g.mid]||(c[g.mid]=[]
),
c[g.mid].push(g.id)
),
...
m[g.stpid].push(g.id))}if(null!=i.orderBy&&c)for(var T in c)c[T].sort((function(t,r){var a=e[t].order,n=e[r].order;return"number"==typeof a||"number"==typeof n?(null==a&&(a=-1
),
null==n&&(n=-1
),
i.orderBy.desc?n-a:a-n):"string"==typeof a||"string"==typeof n?(null==a&&(a=""
...
i.orderBy.desc?n.localeCompare(a):a.localeCompare(n)):void 0}));for(p=0;p<d.length;p++){var b=e[d[p]];if(b){var v=[];FamilyTree.manager._iterateSetRootIds(b.id,b.id,m,c,e,v
),
l.push(v)}}for(p=0;p<l.length;p++)for(var F=0;F<l.length;F++)if(F!=p){for(var x=l[p],_=l[F],w=!1,k=0;k<x.length;k++)if(_.has(x[k])){w=!0;break}w&&(l[p]=x.concat(_).unique(
),
l[F]=[])}for(p=l.length-1;p>=0;p--)l[p].length||l.splice(p,1);if(!i.roots||!i.roots.length){i.roots=[];for(p=l.length-1;p>=0;p--)i.roots.push(l[p][0])}for(p=0;p<i.roots.length;p++)FamilyTree.manager._iterateFT(i.roots[p],m,c,e,n,t,r,a,i)},FamilyTree.manager._iterateSetRootIds=function(e,t,i,r,a,n){var l=a[e];if(l){l.rids.has(t)||l.rids.push(t);for(var o=0;o<l.rids.length;o++)n.has(l.rids[o])||n.push(l.rids[o]);for(o=0;o<l.pids.length;o++){var s=a[l.pids[o]];if(s)for(var d=0;d<s.rids.length;d++)n.has(s.rids[d])||n.push(s.rids[d])}if(i[l.id])for(o=0;o<i[l.id].length;o++)FamilyTree.manager._iterateSetRootIds(i[l.id][o],t,i,r,a,n);if(r[l.id])for(o=0;o<r[l.id].length;o++)FamilyTree.manager._iterateSetRootIds(r[l.id][o],t,i,r,a,n)}},FamilyTree.manager._iterateFT=function(e,t,i,r,a,n,l,o,s){var d,c=r[e],m=a?a[e]:null,p=r[c.stpid],h=r[c.mid],f=r[c.fid];if(p||(c.stpid=null
),
h?f&&(h.tags.has("partner")||h.tags.has("left-partner")||h.tags.has("right-partner"))?(c.pid=f.id,d=f,c.ppid=h.id):(c.pid=h.id,d=h,f&&(c.ppid=f.id)):f?h&&(f.tags.has("partner")||f.tags.has("left-partner")||f.tags.has("right-partner"))?(c.pid=h.id,d=h,c.ppid=f.id):(c.pid=f.id,d=f,h&&(c.ppid=h.id)):c.pid,p){var u=a?a[p.id]:null;u&&(p.min=u.min
),
p.stChildrenIds.push(c.id)}else h||f?(m&&(c.collapsed=m.collapsed,c.min=m.min
),
d&&!d.childrenIds.has(c.id)&&d.childrenIds.push(c.id
),
h&&!h.ftChildrenIds.has(c.id)&&h.ftChildrenIds.push(c.id
),
f&&!f.ftChildrenIds.has(c.id)&&f.ftChildrenIds.push(c.id)):(m&&(c.collapsed=m.collapsed,c.min=m.min
),
n.push(c));l==FamilyTree.action.init&&(c.min=FamilyTree._getMin(c,s));for(var y=0;y<c.pids.length;y++){var g=r[c.pids[y]];if(g){g.pid=c.id;var T=a?a[g.id]:null;if(T&&(g.collapsed=T.collapsed,g.min=T.min
),
...
FamilyTree.templates.john_male.node+='<use x="0" y="0" xlink:href="#male_circle" />',FamilyTree.templates.john_male.ripple={radius:60,color:"#039BE5",rect:null},FamilyTree.templates.john_female=Object.assign({},FamilyTree.templates.john
),
FamilyTree.templates.john_female.node+='<use x="0" y="0" xlink:href="#female_circle" />',FamilyTree.templates.john_female.ripple={radius:60,color:"#F57C00",rect:null},FamilyTree.templates.tommy=Object.assign({},FamilyTree.templates.base
),
...
FamilyTree.templates.tommy_male.node='<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#039BE5" stroke="#aeaeae" rx="7" ry="7"></rect>',FamilyTree.templates.tommy_female=Object.assign({},FamilyTree.templates.tommy
),
FamilyTree.templates.tommy_female.node='<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#F57C00" stroke="#aeaeae" rx="7" ry="7"></rect>',FamilyTree.templates.hugo=Object.assign({},FamilyTree.templates.base
),
...
FamilyTree.templates.hugo_male.node='<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill=url(#hugo_grad_male) stroke="#aeaeae" rx="7" ry="7"></rect>',FamilyTree.templates.hugo_female=Object.assign({},FamilyTree.templates.hugo
),
FamilyTree.templates.hugo_female.node='<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill=url(#hugo_grad_female) stroke="#aeaeae" rx="7" ry="7"></rect>',FamilyTree.templates.mother=Object.assign({},FamilyTree.templates.base
),
FamilyTree.templates.mother.up="",FamilyTree.templates.mother.node='<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;"  stroke-width="1" stroke="#F57C00" rx="5" ry="5"></rect><text style="font-size: 18px;" fill="#F57C00" x="240" y="30" text-anchor="end">Add mother</text>'+FamilyTree.icon.mother(70,70,"#F57C00",10,40
),
FamilyTree.templates.mother.field_0="",FamilyTree.templates.mother.field_1="",FamilyTree.templates.father=Object.assign({},FamilyTree.templates.mother
),
...
FamilyTree.templates.partner.node='<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#aeaeae;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#aeaeae" x="240" y="30" text-anchor="end">Add partner</text>',FamilyTree.templates.son=Object.assign({},FamilyTree.templates.mother
),
...
FamilyTree.templates.cgroup.defs="",FamilyTree.templates.cgroup.size=[250,120],FamilyTree.templates.cgroup.padding=[0,0,0,0],FamilyTree.templates.cgroup.node="",FamilyTree.templates.split=Object.assign({},FamilyTree.templates.base
),
FamilyTree.templates.split.size=[10,10],FamilyTree.templates.split.node='<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>',FamilyTree.templates.mirror={linkAdjuster:{},link:"",node:"",nodeMenuButton:"",size:[0,0]},FamilyTree.ui={_defsIds:{},defs:function(e){var t="";for(var i in FamilyTree.templates){var r=FamilyTree.templates[i];r.defs&&(FamilyTree.ui._defsIds[i]=FamilyTree.randomId(
),
t+=r.defs.replaceAll("{randId}",FamilyTree.ui._defsIds[i]))}return"<defs>"+t+e+"</defs>"},lonely:function(e){return e.nodes&&e.nodes.length?"":FamilyTree.IT_IS_LONELY_HERE.replace("{link}",FamilyTree.RES.IT_IS_LONELY_HERE_LINK)},pointer:function(e,t,i){return t===FamilyTree.action.exporting?"":FamilyTree.t(e.template,!1,i).pointer},node:function(e,t,i,r,a,n,l,o,s,d){var c=FamilyTree.t(e.templateName,e.min,s
),
m=c.node.replaceAll("{w}",e.w).replaceAll("{h}",e.h);c.defs&&(m=m.replaceAll("{randId}",FamilyTree.ui._defsIds[e.templateName])
),
null==l&&(l=r.nodeBinding);var p={node:e,data:t};for(var h in l){var f,u=l[h];t&&(f=t[u]);var y=FamilyTree._lblIsImg(r,h);if(p.value=f,p.element=c[h],p.name=u,!1!==FamilyTree.events.publish("field",[d,p])&&null!=p.value&&null!=p.value&&null!=p.element){if(!y&&"string"==typeof p.value){var g=p.element;g&&(g=g.replaceAll("{ew}",e.w-(e.padding?e.padding[1]:0)).replaceAll("{cw}",e.w/2)
),
p.value=FamilyTree.wrapText(p.value,g)}var T=p.element.replace("{val}",p.value);m+=T=T.replaceAll("{ew}",e.w-(e.padding?e.padding[1]:0)).replaceAll("{cw}",e.w/2).replaceAll("{randId}",FamilyTree.randomId()).replaceAll("{randId2}",FamilyTree.randomId())}}var b=FamilyTree._getPosition(i,e,a,n
),
v="node";Array.isArray(e.tags)&&e.tags.length&&(v+=" "+e.tags.join(" ")
),
e.layout&&(v+=" tree-layout");var F="";e.lcn&&(F='lcn="'+e.lcn+'"');var x=FamilyTree.nodeOpenTag.replace("{lcn}",F).replace("{id}",e.id).replace("{class}",v).replace("{sl}",e.sl).replace("{level}",e.level).replace("{x}",b.x).replace("{y}",b.y
),
_=FamilyTree._getOpacity(i,e);return m=(x=x.replace("{opacity}",_))+(m+=FamilyTree.ui.nodeBtns(r,e,o,c,d))+FamilyTree.grCloseTag},nodeBtns:function(e,t,i,r,a){var n="";return null==e.nodeMenu||t.isSplit||i===FamilyTree.action.exporting||(n+=r.nodeMenuButton.replace("{id}",t.id).replace("{cw}",t.w/2).replace("{ch}",t.h/2).replace("{ew}",t.w-(t.padding?t.padding[1]:0)).replace("{eh}",t.h-(t.padding?t.padding[2]:0))
),
...
this.innerBar.innerHTML="&nbsp",Object.assign(this.bar.style,{position:"absolute",right:0,bottom:0,height:e+"px","overflow-y":"scroll",width:"20px"}
),
this.element.appendChild(this.bar
),
this.bar.appendChild(this.innerBar
...
r.innerHTML='<div id="bft-ppdf-content" style="width: 100%;margin-top:10px;margin-bottom:10px;opacity:0;"></div>';var a,n,l,o=e.element.querySelector("#bft-ppdf-size"
),
...
p=e.element.querySelector("#bft-ppdf-footer");o.value=t.format,s.value=t.landscape,d.value=t.scale,c.value=t.margin,m.value=t.header,p.value=t.footer,FamilyTree.animate(e.element.querySelector("#bft-ppdf-btns"
),
{margin:[0,0,0,-250]},{margin:[0,0,0,0]},300,FamilyTree.anim.outSin,(function(){e.exportPDF(t,FamilyTree.pdfPrevUI._handler)})
),
e.element.querySelector("#bft-prev-cancel").addEventListener("click",(function(){FamilyTree.pdfPrevUI.hide(e)})
),
e.element.querySelector("#bft-prev-save").addEventListener("click",(function(){e.exportPDF(t
),
FamilyTree.pdfPrevUI.hide(e)})
),
FamilyTree.pdfPrevUI._showHide(o,s,d
),
o.addEventListener("change",(function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="",t.format=o.value,e.exportPDF(t,FamilyTree.pdfPrevUI._handler
),
FamilyTree.pdfPrevUI._showHide(o,s,d)}))})
),
s.addEventListener("change",(function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="",t.landscape="true"==s.value,e.exportPDF(t,FamilyTree.pdfPrevUI._handler
),
FamilyTree.pdfPrevUI._showHide(o,s,d)}))})
),
d.addEventListener("change",(function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="",t.scale=d.value,e.exportPDF(t,FamilyTree.pdfPrevUI._handler
),
FamilyTree.pdfPrevUI._showHide(o,s,d)}))})
),
c.addEventListener("keyup",(function(){clearTimeout(a
),
a=setTimeout((function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="";var i=c.value.split(",");if(4==i.length){for(var r=0;r<i.length;r++)i[r]=parseInt(i[r]);t.margin=i,e.exportPDF(t,FamilyTree.pdfPrevUI._handler)}}))}
),
1e3)})
),
m.addEventListener("keyup",(function(){clearTimeout(n
),
n=setTimeout((function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="",t.header=m.value,e.exportPDF(t,FamilyTree.pdfPrevUI._handler)}))}
),
1e3)})
),
p.addEventListener("keyup",(function(){clearTimeout(l
),
l=setTimeout((function(){FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"
),
{opacity:1},{opacity:0},300,FamilyTree.anim.inSin,(function(){e.element.querySelector("#bft-ppdf-content").innerHTML="",t.footer=p.value,e.exportPDF(t,FamilyTree.pdfPrevUI._handler)}))}
),
1e3)}))},FamilyTree.pdfPrevUI._showHide=function(e,t,i){"A4"==e.value||"A3"==e.value||"A2"==e.value||"A1"==e.value||"Letter"==e.value||"Legal"==e.value?(t.parentNode.style.display="block",i.parentNode.style.display="block"):(t.parentNode.style.display="none",i.parentNode.style.display="none")},FamilyTree.pdfPrevUI._handler=function(e,t,i){var r=t.options,a=t.pages,n=r.margin[0],l=r.margin[2],o=document.createElement("div");o.classList.add(e.config.mode
),
o.innerHTML=i.outerHTML,FamilyTree._browser().msie&&(o.innerHTML=(new XMLSerializer).serializeToString(i));for(var s=o.querySelector("svg"
),
d=e.element.querySelector("#bft-ppdf-content"
),
c=0;c<a.length;c++){var m=document.createElement("iframe");Object.assign(m.style,{display:"block",margin:"10px auto",border:"1px solid #eeeeee","box-shadow":"0 4px 8px 0 rgba(0, 0, 0, 0.2
),
 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}
),
d.appendChild(m
),
s&&s.style.backgroundColor?m.style.backgroundColor=s.style.backgroundColor:m.style.backgroundColor="#fff";var p=m.contentWindow.document;p.open(
),
m.style.width=a[c].size.w+"px",m.style.height=a[c].size.h+"px",m.style.margin="10 auto",a[c].backgroundColor&&(m.style.backgroundColor=a[c].backgroundColor);var h=r.header;a[c].header&&(h=a[c].header
),
h&&(h=h.replace("{current-page}",c+1).replace("{total-pages}",a.length));var f=r.footer;a[c].footer&&(f=a[c].footer
),
...
p.write(FamilyTree._exportHtml(o.innerHTML,t.styles,r,a[c].innerSize.w,a[c].innerSize.h,h,f,e.config.mode)));var u=p.getElementById("bft-header"
),
y=p.getElementById("bft-footer");if(u){var g=n-u.offsetHeight-7;u.style.top=g+"px"}if(y){var T=l-y.offsetHeight-7;y.style.bottom=T+"px"}p.close()}var b=e.element.querySelector("#bft-ppdf-content");FamilyTree.animate(b,{opacity:0},{opacity:1},300,FamilyTree.anim.outSin)},FamilyTree.pdfPrevUI._getViewBox=function(e){var t=null;return e?(t=(t="["+(t=e.getAttribute("viewBox"))+"]").replace(/\ /g,","
),
t=JSON.parse(t)):null},FamilyTree._exportHtml=function(e,t,i,r,a,n,l,o){for(var s="",d=0;d<i.margin.length;d++)s+=i.margin[d]+"px ";var c='<!DOCTYPE html><html style="margin:0;padding:0;"><head></head>'+t+'<body class="bft-'+o+'" style="margin:0; padding:0;"><div style="margin: '+s+";overflow:hidden;width:"+r+"px;height:"+a+'px">';return n&&(c+='<div id="bft-header" style="width:'+r+"px;color:#757575;position:absolute;left:"+i.margin[3]+'px;top:0;">'+n+"</div>"
),
c+=e,l&&(c+='<div id="bft-footer" style="width:'+r+"px;color:#757575;position:absolute;left:"+i.margin[3]+'px;bottom:0;">'+l+"</div>"
),
c+="</div>",c+="</body></html>"},FamilyTree.pdfPrevUI.hide=function(e){var t=e.element.querySelector("#bft-ppdf-wrapper");if(t){t.parentNode.removeChild(t
),
t.style.opacity=0;var i=e.element.querySelector("#bft-ppdf-btns");i.parentNode.removeChild(i)}},void 0===FamilyTree&&(FamilyTree={}
),
FamilyTree.events.on("renderdefs",(function(e,t){for(var i=0;i<e.config.clinks.length;i++){var r=e.config.clinks[i].template;r||(r="orange");var a=FamilyTree.clinkTemplates[r];t.defs+=a.defs}})
),
FamilyTree.events.on("render",(function(e,t){e._clink(e,t)})
),
FamilyTree.prototype._clink=function(e,t){for(var i,r,a,n,l,o="",s=0;s<this.config.clinks.length;s++){var d=this.config.clinks[s],c=e.getNode(d.from
),
m=e.getNode(d.to);if(c&&-1!=t.res.visibleNodeIds.indexOf(c.id)&&(m&&-1!=t.res.visibleNodeIds.indexOf(m.id))){var p=c.x,h=c.y,f=m.x,u=m.y,y={},g={},T=p+c.w/2,b=f+m.w/2,v=h+c.h/2,F=u+m.h/2,x=1;switch(this.config.orientation){case FamilyTree.orientation.top:case FamilyTree.orientation.top_left:T<=b?(x=1,y.x=T+c.w/10,g.x=b-m.w/10):(x=-1,y.x=T-c.w/10,g.x=b+m.w/10
),
h==u?(x=1,y.y=h,g.y=u):h>u?(y.y=h,g.y=u+m.h):(y.y=h+c.h,g.y=u);break;case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:T<=b?(x=-1,y.x=T+c.w/10,g.x=b+m.w/10):(x=1,y.x=T-c.w/10,g.x=b+m.w/10
),
h==u?(x=-1,y.y=h+c.h,g.y=u+m.h):h>u?(y.y=h,g.y=u+m.h):(y.y=h+c.h,g.y=u);break;case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:v<=F?(x=-1,y.y=v+c.h/5,g.y=F+m.h/5):(x=1,y.y=v-c.h/5,g.y=F+m.h/5
),
p==f?(x=-1,y.x=p,g.x=f):p>f?(y.x=p,g.x=f+m.w):(y.x=p+c.w,g.x=f);break;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:v<=F?(x=1,y.y=v+c.h/5,g.y=F+m.h/5):(x=-1,y.y=v-c.h/5,g.y=F+m.h/5
),
p==f?(x=1,y.x=p+c.w,g.x=f+m.w):p>f?(y.x=p,g.x=f+m.w):(y.x=p+c.w,g.x=f)}var _=I(y,g,x
),
...
s.push([s[s.length-1][0],d.y]);break;case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:u.q=t.y+t.h,u.s=a.maxY-f,s.push([u.p,u.q]
),
...
s.push([s[s.length-1][0],d.y+d.h]);break;case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:u.p=t.x,u.q=t.y+t.h/2+h.expandCollapseSize,u.r=a.minX-f,u.s=t.y+t.h/2+h.expandCollapseSize,s.push([u.p,u.q]
),
s.push([t.x-f/3,u.q]
),
h=FamilyTree.t(d.templateName,d.min,r
...
s.push([d.x,s[s.length-1][1]]);break;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:u.p=t.x+t.w,u.q=t.y+t.h/2+h.expandCollapseSize,u.r=a.maxX+f,u.s=t.y+t.h/2+h.expandCollapseSize,s.push([u.p,u.q]
),
...
s.push([d.x+d.w,s[s.length-1][1]])}else{switch(p.orientation){case FamilyTree.orientation.top:case FamilyTree.orientation.top_left:s.push([u.p,u.q]
),
s.push([u.r,t.y-f/3]);break;case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:u.q=t.y+t.h,u.s=a.maxY-f,s.push([u.p,u.q]
),
s.push([u.r,t.y+t.h+f/3]);break;case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:u.p=t.x,u.q=t.y+t.h/2+h.expandCollapseSize,u.r=a.minX-f,u.s=t.y+t.h/2+h.expandCollapseSize,s.push([u.p,u.q]
),
s.push([t.x-f/3,u.q]);break;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:u.p=t.x+t.w,u.q=t.y+t.h/2+h.expandCollapseSize,u.r=a.maxX+f,u.s=t.y+t.h/2+h.expandCollapseSize,s.push([u.p,u.q]
),
s.push([t.x+t.w+f/3,u.q])}for(var y=t;null==d;){var g=!1,T=y.parent,b=T.leftNeighbor,v=T.rightNeighbor;if(T.id==n.id?d=T:FamilyTree._intersects(T,u,e.config)&&(u=FamilyTree._addPoint(T,s,e.config,u,c
),
g=!0
),
T.id!=n.id){for(;b;){if(b.id==n.id){d=b;break}FamilyTree._intersects(b,u,e.config)&&(u=FamilyTree._addPoint(b,s,e.config,u,c
),
g=!0
),
b=b.leftNeighbor}for(;v;){if(v.id==n.id){d=v;break}FamilyTree._intersects(v,u,e.config)&&(u=FamilyTree._addPoint(v,s,e.config,u,c
),
g=!0
),
v=v.rightNeighbor}}if(!g){var F=s[s.length-1][0],x=0;if(T.parent)switch(f=p.levelSeparation,T.parent.layout!=FamilyTree.mixed&&T.parent.layout!=FamilyTree.tree||(f=p.mixedHierarchyNodesSeparation
),
p.orientation){case FamilyTree.orientation.top:case FamilyTree.orientation.top_left:x=T.parent.y+T.parent.h+f*(2/3);break;case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:x=T.parent.y-f*(2/3);break;case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:F=T.parent.x+T.parent.w+f*(2/3
),
x=s[s.length-1][1];break;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:F=T.parent.x-f*(2/3
),
x=s[s.length-1][1]}s.push([F,x])}y=T}switch(h=FamilyTree.t(d.templateName,d.min,r
),
s.splice(s.length-1,1
),
p.orientation){case FamilyTree.orientation.top:case FamilyTree.orientation.top_left:s.push([d.x+d.w/2+h.expandCollapseSize,s[s.length-1][1]]
),
s.push([s[s.length-1][0],d.y+d.h]);break;case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:s.push([d.x+d.w/2+h.expandCollapseSize,s[s.length-1][1]]
),
s.push([s[s.length-1][0],d.y]);break;case FamilyTree.orientation.left:case FamilyTree.orientation.left_top:s.push([s[s.length-1][0],d.y+d.h/2+h.expandCollapseSize]
),
s.push([d.x+d.w,s[s.length-1][1]]);break;case FamilyTree.orientation.right:case FamilyTree.orientation.right_top:s.push([s[s.length-1][0],d.y+d.h/2+h.expandCollapseSize]
),
s.push([d.x,s[s.length-1][1]])}}var _=o.template;_||(_="orange");var w,k,S=null;switch((h=FamilyTree.slinkTemplates[_]).labelPosition){case"start":S={x:s[1][0],y:s[1][1]};break;case"middle":var C=Math.ceil(s.length/2);w=s[C],k=s[C-1],S={x:(w[0]+k[0])/2,y:(w[1]+k[1])/2};break;case"end":S={x:s[s.length-2][0],y:s[s.length-2][1]}}l&&(s=s.reverse()
),
s[0]="M"+s[0].join(",");for(var I=1;I<s.length;I++)s[I]="L"+s[I].join(",");var A=s.join(" ");if(o.label){var N=h.label.replace("{x}",S.x).replace("{y}",S.y).replace("{val}",o.label
),
M=FamilyTree._getLabelSize(N
),
E=-M.height/2;switch(p.orientation){case FamilyTree.orientation.bottom:case FamilyTree.orientation.bottom_left:E=M.height}i+=h.label.replace("{x}",S.x).replace("{y}",S.y+E).replace("{val}",o.label)}var L=t.id,O=n.id;l&&(L=n.id,O=t.id
),
i+=("<g "+FamilyTree.attr.s_link_from+'="{from}" '+FamilyTree.attr.s_link_to+'="{to}">').replace("{from}",L).replace("{to}",O)+h.link.replaceAll("{d}",A)+'<path stroke="transparent" stroke-width="15" fill="none" d="'+A+'" />',i+=FamilyTree.grCloseTag}for(var l=0;l<this.config.slinks.length;l++){var o=this.config.slinks[l],s=e.getNode(o.from
),
d=e.getNode(o.to);s&&d&&-1!=t.res.visibleNodeIds.indexOf(d.id)&&-1!=t.res.visibleNodeIds.indexOf(s.id)&&(s.sl>=d.sl?n(s,d,!1):n(d,s,!0))}t.content+=i},FamilyTree.prototype.addSlink=function(e,t,i,r){return this.removeClink(e,t
),
this.config.slinks.push({from:e,to:t,label:i,template:r}
),
this},FamilyTree.prototype.removeSlink=function(e,t){for(var i=this.config.slinks.length-1;i>=0;i--){var r=this.config.slinks[i];r.from==e&&r.to==t&&this.config.slinks.splice(i,1)}return this},FamilyTree.slinkTemplates={},FamilyTree.slinkTemplates.orange={defs:'<marker id="arrowSlinkOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#F57C00" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#F57C00" /></marker>',link:'<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkOrange)" marker-end="url(#arrowSlinkOrange)" stroke-linejoin="round" stroke="#F57C00" stroke-width="2" fill="none" d="{d}" />',label:'<text dominant-baseline="middle" fill="#F57C00" alignment-baseline="middle" text-anchor="middle" x="{x}" y="{y}">{val}</text>',labelPosition:"middle"},FamilyTree.slinkTemplates.blue={defs:'<marker id="arrowSlinkBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#039BE5" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#039BE5" /></marker>',link:'<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#039BE5" stroke-width="2" fill="none" d="{d}" />',label:'<text fill="#039BE5" text-anchor="middle" x="{x}" y="{y}">{val}</text>',labelPosition:"middle"},FamilyTree.slinkTemplates.yellow={defs:'<marker id="arrowSlinkYellow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#FFCA28" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkYellow" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#FFCA28" /></marker>',link:'<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkYellow)" marker-end="url(#arrowSlinkYellow)" stroke-linejoin="round" stroke="#FFCA28" stroke-width="2" fill="none" d="{d}" />',label:'<text  fill="#FFCA28" text-anchor="middle" x="{x}" y="{y}">{val}</text>',labelPosition:"middle"},FamilyTree.events.on("renderbuttons",(function(e,t){if(t.node&&t.node.tags&&t.node.tags.has("group-dotted-lines")){var i=e.getScale(
),
r=FamilyTree.t(t.node.templateName,t.node.min,i
),
a="";t.node.min?(r.nodeGroupDottedOpenButton||console.error(`[${t.node.templateName}].nodeGroupDottedOpenButton is not defined`
),
a+=`<g style="cursor:pointer;"  data-ctrl-n-dotted-open="${t.node.id}" transform="matrix(1,0,0,1,${t.node.x},${t.node.y})">`,a+=r.nodeGroupDottedOpenButton):(r.nodeGroupDottedCloseButton||console.error(`[${t.node.templateName}].nodeGroupDottedCloseButton is not defined`
),
a+=`<g style="cursor:pointer;" transform="matrix(1,0,0,1,${t.node.x},${t.node.y})" data-ctrl-n-dotted-close="${t.node.id}">`,a+=r.nodeGroupDottedCloseButton
),
a=(a+="</g>").replaceAll("{cw}",t.node.w/2).replaceAll("{ch}",t.node.h/2).replaceAll("{ew}",t.node.w-(t.node.padding?t.node.padding[1]:0)).replaceAll("{eh}",t.node.h-(t.node.padding?t.node.padding[2]:0));var n=e.getNode(t.node.stChildrenIds[0]);if(-1!=a.indexOf("{collapsed-children-count}")){var l=FamilyTree.collapsedChildrenCount(e,n);a=a.replace("{collapsed-children-count}",l)}if(-1!=a.indexOf("{collapsed-children-total-count}")){var o=FamilyTree.collapsedChildrenTotalCount(e,n);a=a.replace("{collapsed-children-total-count}",o)}if(-1!=a.indexOf("{children-count}")){var s=FamilyTree.childrenCount(e,n);a=a.replace("{children-count}",s)}if(-1!=a.indexOf("{children-total-count}")){var d=FamilyTree.childrenTotalCount(e,n);a=a.replace("{children-total-count}",d)}t.html+=a}})
),
FamilyTree.events.on("redraw",(function(e,t){if(e.config.groupDottedLines.length){for(var i=e.element.querySelectorAll("[data-ctrl-n-dotted-close]"
),
r=0;r<i.length;r++)i[r].addEventListener("click",(function(){var t=this.getAttribute("data-ctrl-n-dotted-close");e.minimize(t)}));var a=e.element.querySelectorAll("[data-ctrl-n-dotted-open]");for(r=0;r<a.length;r++)a[r].addEventListener("click",(function(){var t=this.getAttribute("data-ctrl-n-dotted-open");e.maximize(t)}))}})
),
FamilyTree.events.on("redraw",(function(e,t){if(e.config.miniMap&&e.manager.action!=FamilyTree.action.move){FamilyTree.miniMap._settings._scale=Math.min(FamilyTree.miniMap.width/(e.response.boundary.maxX-e.response.boundary.minX
),
FamilyTree.miniMap.height/(e.response.boundary.maxY-e.response.boundary.minY)
),
FamilyTree.miniMap._settings._translateX=-e.response.boundary.minX*FamilyTree.miniMap._settings._scale+(FamilyTree.miniMap.width-(e.response.boundary.maxX-e.response.boundary.minX)*FamilyTree.miniMap._settings._scale)/2,FamilyTree.miniMap._settings._translateY=-e.response.boundary.minY*FamilyTree.miniMap._settings._scale+(FamilyTree.miniMap.height-(e.response.boundary.maxY-e.response.boundary.minY)*FamilyTree.miniMap._settings._scale)/2;var i=e.getViewBox();FamilyTree.miniMap._init(e
),
FamilyTree.miniMap._drawMainCanvas(e
),
FamilyTree.miniMap._drawRectSelectorCanvas(e,i);var r,a,n,l,o=e.element.querySelector('[data-id="mini-map-focus"]'
),
s=!1,d=null;o.onmousedown=function(e){var t,n,l,d=o.getBoundingClientRect(
),
c=d.left,m=d.top;if(r=parseInt(e.clientX-c
),
a=parseInt(e.clientY-m
),
t=a,n=(r-FamilyTree.miniMap._settings._translateX)/FamilyTree.miniMap._settings._scale,l=(t-FamilyTree.miniMap._settings._translateY)/FamilyTree.miniMap._settings._scale,n>i[0]&&n<i[0]+i[2]&&l>i[1]&&l<i[1]+i[3])return e.preventDefault(
),
e.stopPropagation(
),
void(s=!0)},o.onmousemove=function(t){if(s){t.preventDefault(
),
t.stopPropagation();var c=o.getBoundingClientRect(
),
m=c.left,p=c.top;n=parseInt(t.clientX-m
),
l=parseInt(t.clientY-p);var h=(n-r)/FamilyTree.miniMap._settings._scale,f=(l-a)/FamilyTree.miniMap._settings._scale;i[0]=h+i[0],i[1]=f+i[1],e.setViewBox(i
),
d&&(clearTimeout(d
),
d=null
),
d=setTimeout((function(){e._draw(!0,FamilyTree.action.move)}
),
300
),
FamilyTree.miniMap._drawRectSelectorCanvas(e,i
),
r=n,a=l}},o.onmouseup=function(e){s&&(e.preventDefault(
),
e.stopPropagation(
),
s=!1)},o.onmouseout=function(e){s&&(e.preventDefault(
),
e.stopPropagation(
),
s=!1)}}})
),
FamilyTree.miniMap={},FamilyTree.miniMap._settings={_translateX:0,_translateY:0,_scale:1},FamilyTree.miniMap._drawMainCanvas=function(e){var t=e.element.querySelector('[data-id="mini-map-main"]'
),
i=t.getContext("2d");FamilyTree.miniMap._initCtx(e,t,1);var r=0,a=[];!function e(t,n){if(Array.isArray(n))for(var l=0;l<n.length;l++)e(t,n[l]);else{i.fillStyle=FamilyTree.miniMap.colors[3],i.beginPath(
),
i.lineWidth="0.5",i.fillRect(n.x,n.y,n.w,n.h
),
i.strokeRect(n.x,n.y,n.w,n.h);for(l=0;l<n.stChildrenIds.length;l++)r++,a.includes(n.id)||(1==r?i.fillStyle=FamilyTree.miniMap.colors[0]:2==r?i.fillStyle=FamilyTree.miniMap.colors[1]:3==r&&(i.fillStyle=FamilyTree.miniMap.colors[2]
),
i.beginPath(
),
...
r--;for(l=0;l<n.childrenIds.length;l++)e(t,t.getNode(n.childrenIds[l]))}}(e,e.roots)},FamilyTree.miniMap._drawRectSelectorCanvas=function(e,t){var i=e.element.querySelector('[data-id="mini-map-focus"]'
),
r=i.getContext("2d");FamilyTree.miniMap._initCtx(e,i,FamilyTree.miniMap.opacity);var a=t[0],n=t[1],l=t[2],o=t[3];r.lineWidth=.5/FamilyTree.miniMap._settings._scale,r.strokeStyle=FamilyTree.miniMap.focusStroke,r.globalAlpha=1,r.clearRect(a,n,l,o
),
r.strokeRect(a,n,l,o)},FamilyTree.miniMap._initCtx=function(e,t,i){var r=t.getContext("2d");t.width=t.width,t.height=t.height,r.clearRect(0,0,FamilyTree.miniMap.width,FamilyTree.miniMap.height
),
r.globalAlpha=i,1!=i&&(r.fillStyle=FamilyTree.miniMap.selectorBackgroundColor,r.fillRect(0,0,FamilyTree.miniMap.width,FamilyTree.miniMap.height)
),
r.translate(FamilyTree.miniMap._settings._translateX,FamilyTree.miniMap._settings._translateY
),
r.scale(FamilyTree.miniMap._settings._scale,FamilyTree.miniMap._settings._scale)},FamilyTree.miniMap._init=function(e){if(!e.element.querySelector('[data-id="mini-map"]')){var t=document.createElement("canvas");t.width=FamilyTree.miniMap.width,t.height=FamilyTree.miniMap.height,t.setAttribute("data-id","mini-map-main"
),
t.style.display="inline-block",t.style.backgroundColor=FamilyTree.miniMap.backgroundColor,t.style.position="absolute",t.style.top=0,t.style.left=0;var i=document.createElement("canvas");i.width=FamilyTree.miniMap.width,i.height=FamilyTree.miniMap.height,i.setAttribute("data-id","mini-map-focus"
),
i.style.display="inline-block",i.style.position="absolute",i.style.top=0,i.style.left=0;var r=document.createElement("div");r.setAttribute("data-id","mini-map"
),
r.style.position="absolute";for(var a=["top","right","left","bottom"],n=0;n<a.length;n++){var l=a[n];FamilyTree.isNEU(FamilyTree.miniMap.position[l])||("padding"==FamilyTree.miniMap.position[l]?r.style[l]=e.config.padding+"px":r.style[l]=FamilyTree.miniMap.position[l]+"px")}r.style.border=FamilyTree.miniMap.border,r.style.padding=FamilyTree.miniMap.padding+"px",r.style.backgroundColor=FamilyTree.miniMap.backgroundColor;var o=document.createElement("div");o.style.position="relative",o.style.width=FamilyTree.miniMap.width+"px",o.style.height=FamilyTree.miniMap.height+"px",o.appendChild(t
),
o.appendChild(i
),
r.appendChild(o
),
e.element.appendChild(r);var s=function(t,i){e.__mouseScrollHandler(r,i)};e._addEvent(r,"DOMMouseScroll",s
),
e._addEvent(r,"mousewheel",s);var d=0,c=0,m=function(e){var t=e.clientX-d,i=e.clientY-c;if(!FamilyTree.isNEU(r.style.left)){var a=parseFloat(r.style.left)+t;r.style.left=`${a}px`}if(!FamilyTree.isNEU(r.style.right)){var n=parseFloat(r.style.right)-t;r.style.right=`${n}px`}if(!FamilyTree.isNEU(r.style.bottom)){var l=parseFloat(r.style.bottom)-i;r.style.bottom=`${l}px`}if(!FamilyTree.isNEU(r.style.top)){var o=parseFloat(r.style.top)+i;r.style.top=`${o}px`}d=e.clientX,c=e.clientY},p=function(){document.removeEventListener("mousemove",m
),
document.removeEventListener("mouseup",p)};FamilyTree.miniMap.draggable&&r.addEventListener("mousedown",(function(e){d=e.clientX,c=e.clientY,document.addEventListener("mousemove",m
),
document.addEventListener("mouseup",p)}))}},FamilyTree.miniMap.colors=["#E0E0E0","#BDBDBD","#9E9E9E","#757575"],FamilyTree.miniMap.selectorBackgroundColor="white",FamilyTree.miniMap.backgroundColor="white",FamilyTree.miniMap.focusStroke="#f57c00",FamilyTree.miniMap.opacity=.4,FamilyTree.miniMap.border="1px solid #aeaeae",FamilyTree.miniMap.width=250,FamilyTree.miniMap.height=140,FamilyTree.miniMap.padding=5,FamilyTree.miniMap.position={top:void 0,left:"padding",right:void 0,bottom:"padding"},FamilyTree.miniMap.draggable=!0,FamilyTree._search={},FamilyTree._search.search=function(e,t,i,r,a,n,l){var o=[],s=t.toLowerCase(
),
d=s.split(" ");if(l&&d.length>1){var c=d[0];l[c]&&(i=[l[c]],d=(s=s.replace(c,"").trim()).split(" "))}d=d.filter((function(e,t,i){return i.indexOf(e)===t}));for(var m={},p=0;p<e.length;p++)for(var h=e[p],f=0;f<i.length;f++){var u=i[f];if(!FamilyTree.isNEU(h[u])){var y=h[u];if(null!=(t=FamilyTree._search.searchAndComputeScore(d,y,u,n))){var g=h.id;if(m[g]){if(m[g]&&m[g]<t.__score){m[g]=t.__score;for(var T=o.length-1;T>=0;T--)o[T].id==g&&o.splice(T,1);FamilyTree._search.addNodeToResult(o,r,h,t,u,a)}}else m[g]=t.__score,FamilyTree._search.addNodeToResult(o,r,h,t,u,a)}}}return o.sort((function(e,t){return e.__score<t.__score?1:e.__score>t.__score?-1:0})
),
o},FamilyTree._search.addNodeToResult=function(e,t,i,r,a,n){var l={};l.id=i.id,FamilyTree.isNEU(i[n])||(l[n]=i[n]);for(var o=0;o<t.length;o++){var s=t[o];FamilyTree.isNEU(i[s])||FamilyTree.isNEU(l[s])&&(l[s]=i[s])}null!=r&&(FamilyTree.isNEU(l.__score)&&(l.__score=r.__score
),
FamilyTree.isNEU(l.__searchField)&&(l.__searchField=a
),
FamilyTree.isNEU(l.__searchMarks)&&(l.__searchMarks=r.__searchMarks)
),
e.push(l)},FamilyTree._search.searchAndComputeScore=function(e,t,i,r){if(FamilyTree.isNEU(t))return null;if(FamilyTree.isNEU(e))return null;if(!e.length)return null;"string"!=typeof t&&(t=t.toString());var a=t.toLowerCase(
),
n=FamilyTree._search.searchIndexesOf(a,e);if(!n.length)return null;for(var l=a.length/100,o=0,s=0,d=o>0?100:0,c=0,m=0;m<e.length;m++)for(var p=e[m],h=0;h<n.length;h++)if(-1!=p.indexOf(n[h].searchPhrase)){c++;break}var f=100/(e.length/c);if(n.length){s=n[0].start;for(h=0;h<n.length;h++)if(o+=n[h].length,n[h].start<s&&(s=n[h].start
),
h>=1&&n[h-1].start>n[h].start){d=0;break}}var u=0;0!=o&&(u=o/l);var y=o>0?100:0;0!=s&&(y=100-s/l);var g=0;r&&r[i]&&(g=r[i]
),
f&&(f=f/100*50
),
u>0&&(u=u/100*10
...
g>0&&(g=g/100*20);var T=Math.round(1e4*(f+u+y+d+g));n.sort((function(e,t){return e.start<t.start?-1:e.start>t.start?1:0}));var b=t;for(h=n.length-1;h>=0;h--)b=(b=b.insert(n[h].start+n[h].length,"</mark>")).insert(n[h].start,"<mark>");return{__searchMarks:b,__score:T}},FamilyTree._search.searchIndexesOf=function(e,t){var i=[];if(!FamilyTree.isNEU(e))for(var r=0;r<t.length;r++){var a=t[r];if(!FamilyTree.isNEU(a))for(var n=0;(n=e.indexOf(a,n))>-1;)i.push({length:a.length,start:n,searchPhrase:a}
),
n+=a.length}return i.sort((function(e,t){return e.length<t.length?1:e.length>t.length||e.start<t.start?-1:e.start>t.start?1:0})
),
i=i.filter((function(e){for(var t=!1,r=0;r<i.length;r++){var a=i[r].start,n=i[r].start+i[r].length-1,l=e.start,o=e.start+e.length-1;if(a==l&&n==o){t=!1;break}if(a>=l&&n<=o){t=!0;break}if(a<=l&&n>=o){t=!0;break}}return!t}))},FamilyTree.events.on("redraw",(function(e,t){if(e.config.state){var i=[],r=[];!function e(t){if(Array.isArray(t))for(var a=0;a<t.length;a++)e(t[a]);else{("string"!=typeof t.id||"string"==typeof t.id&&-1==t.id.indexOf("split")&&-1==t.id.indexOf("mirror"))&&(i.push(t.id
),
1==t.min&&r.push(t.id));for(a=0;a<t.stChildren.length;a++)e(t.stChildren[a]);for(a=0;a<t.children.length;a++)e(t.children[a])}}(e.roots
),
FamilyTree.state._put(e.config.roots,e.width(
),
e.height(
),
e.response.viewBox,i,r,e.response.adjustify,e.config.state)}})
),
FamilyTree.state={},FamilyTree.state._buildStateNames=function(e){return{paramScale:e+"-scale",paramX:e+"-x",paramY:e+"-y",paramExp:e+"-exp",paramMin:e+"-min",paramRoots:e+"-roots",paramAdjustify:e+"-adjustify"}},FamilyTree.state._put=function(e,t,i,r,a,n,l,o){if(o){var s=FamilyTree.state._buildStateNames(o.name
),
d={roots:e,scale:Math.min(t/r[2],i/r[3]
),
x:r[0],y:r[1],exp:a,min:n,adjustify:l};if(o.writeToUrlParams){var c=new URLSearchParams(window.location.search);c.has(s.paramScale)?c.set(s.paramScale,d.scale):c.append(s.paramScale,d.scale
),
...
window.history.replaceState(null,null,"?"+c)}o.writeToIndexedDB&&(d.id=o.name,FamilyTree.idb.put(d,(function(e){0==e&&console.error("Cannot write row - "+o.name)}))
),
o.writeToLocalStorage&&FamilyTree.localStorage.setItem(o.name,JSON.stringify(d))}},FamilyTree.state._get=function(e,t,i,r){if(e){var a=FamilyTree.state._buildStateNames(e.name);if(e.readFromUrlParams){var n=new URLSearchParams(window.location.search);if(n.has(a.paramScale)&&n.has(a.paramX)&&n.has(a.paramY)&&n.has(a.paramExp)&&n.has(a.paramMin)&&n.has(a.paramAdjustify)){var l={},o=parseFloat(n.get(a.paramScale)
),
s=parseFloat(n.get(a.paramX)
),
d=parseFloat(n.get(a.paramY));(m=[])[0]=s,m[1]=d,m[2]=t/o,m[3]=i/o,l.vb=m,l.scale=o,l.x=s,l.y=d,l.roots=null,n.has(a.paramRoots)&&(l.roots=n.get(a.paramRoots).split("*")
),
l.exp=n.get(a.paramExp).split("*"
),
l.min=n.get(a.paramMin).split("*");var c=n.get(a.paramAdjustify).split("*");return l.adjustify={x:parseFloat(c[0]
),
y:parseFloat(c[1])},void r(l)}if(!e.readFromIndexedDB&&!e.readFromLocalStorage)return void r(null)}if(e.readFromLocalStorage){var m;if(null!=(l=FamilyTree.localStorage.getItem(e.name)))return l=JSON.parse(l
),
(m=[])[0]=l.x,m[1]=l.y,m[2]=t/l.scale,m[3]=i/l.scale,l.vb=m,void r(l);if(!e.readFromIndexedDB)return void r(null)}e.readFromIndexedDB&&FamilyTree.idb.read(e.name,(function(a,n){if(0==a)console.error("Cannot read from - "+e.name
),
r(null);else if(null==a)r(null);else{var l=[];l[0]=n.x,l[1]=n.y,l[2]=t/n.scale,l[3]=i/n.scale,n.vb=l,r(n)}}))}else r(null)},FamilyTree.state.clear=function(e){if(!e)return!1;try{localStorage.removeItem(e);var t=FamilyTree.state._buildStateNames(e
),
i=new URLSearchParams(window.location.search);i.has(t.paramScale)&&i.delete(t.paramScale
),
...
FamilyTree.idb.delete(e,(function(t){0==t&&console.error("Cannot delete row - "+e)}))}catch{}},FamilyTree._magnify={},FamilyTree.prototype.magnify=function(e,t,i,r,a){r||(r=this.config.anim);var n=this.getNode(e
),
l=this.getNodeElement(e);if(n||l){var o=FamilyTree._magnify[e];if(o&&(null!=o.timer&&clearInterval(o.timer
),
...
t.push(i);for(var r=0;r<e.stChildren.length;r++)FamilyTree.remote._toReqDTO(e.stChildren[r],t);for(r=0;r<e.children.length;r++)FamilyTree.remote._toReqDTO(e.children[r],t)},FamilyTree.remote._toReqLayoutConfigsDTO=function(e){var t={};for(var i in e){var r=e[i];t[i]||(t[i]=[]
),
t[i][0]=r.orientation,t[i][1]=r.levelSeparation,t[i][2]=r.mixedHierarchyNodesSeparation,t[i][3]=r.subtreeSeparation,t[i][4]=r.siblingSeparation,t[i][5]=r.layout,t[i][6]=r.columns,t[i][7]=r.collapse,t[i][8]=r.assistantSeparation,t[i][9]=r.partnerNodeSeparation}return t},FamilyTree.remote._convertToIdArray=function(e){for(var t=[],i=0;i<e.length;i++)t.push(e[i].id);return t},FamilyTree.remote._setPositions=function(e,t,i,r){for(var a=[],n=[],l=FamilyTree.remote._toReqLayoutConfigsDTO(t
),
o=0;o<e.length;o++)n.push(e[o].id
),
FamilyTree.remote._toReqDTO(e[o],a);var s={n:a,c:l,r:n,v:"8.10.09"};if(FamilyTree.LIMIT_NODES||(s.l=!0
),
null!=FamilyTree.remote._fromReqDTO)FamilyTree.remote._fromReqDTO(s.n,s.r,s.c,(function(t){for(var a=0;a<e.length;a++)FamilyTree.remote._fromResDTO(e[a],t,0,e,r);i()}));else{s=JSON.stringify(s);var d=FamilyTree.localStorage.getItem(s);d&&(d=JSON.parse(d)
),
d&&!d.limit?FamilyTree.remote._proceed(e,d,r,i):FamilyTree.remote._findRegion((function(t){FamilyTree._ajax(t,"post",s,"json",(function(t){t.error?i(2):(FamilyTree.remote._proceed(e,t,r,i
),
FamilyTree.localStorage.setItem(s,JSON.stringify(t)))}))}))}},FamilyTree.remote._proceed=function(e,t,i,r){if("string"==typeof t&&(t=JSON.parse(t)
),
t.limit&&1==t.limit)r(t.limit);else{for(var a=0;a<e.length;a++)FamilyTree.remote._fromResDTO(e[a],t,0,e,i);r()}},FamilyTree.remote._findRegion=function(e){var t=FamilyTree.localStorage.getItem("funcUrl");if(t)e(t);else{for(var i=["au-e","au-se","brs","ca","ca-e","easia","eus-2","eus","fr","ind","jp-e","jp-w","kr","n-eu","se-asia","s-ind","uk-s","uk-w","us","us-n-c","us-s-c","w-c-us","w-eu","w-ind","w-us-2","wus"],r=[],a=0;a<i.length;a++)r.push(new XMLHttpRequest);for(a=0;a<i.length;a++)!function(){var t="https://"+i[a]+"-balkangraph.azurewebsites.net/api/OrgChartJS",n=r[a];n.onreadystatechange=function(){if(4==this.readyState&&200==this.status){FamilyTree.localStorage.setItem("funcUrl",t
),
e(t);for(var i=0;i<r.length;i++)r[i].abort()}},n.open("GET",t,!0
),
n.send()}()}};
